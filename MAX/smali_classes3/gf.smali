...
.field public final e:Loe7;

.field public final f:Ltae;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lkna;Loe7;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lgf;->b:Landroid/content/Context;

    iput-object p2, p0, Lgf;->c:Lkna;

    const-string p1, "MAX"

    iput-object p1, p0, Lgf;->d:Ljava/lang/String;

    iput-object p3, p0, Lgf;->e:Loe7;
...
# virtual methods
.method public final c(Lppc;Ljava/lang/String;)Landroid/net/Uri;
    .locals 8

    const/4 v0, 0x1

    invoke-interface {p1}, Lppc;->e()Ljava/lang/String;

    move-result-object v1

    invoke-interface {p1}, Lppc;->a()I
    ...
    iget-object v6, p0, Lgf;->d:Ljava/lang/String;
    ...
    invoke-direct {v1, v6, p2}, Lfla;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {v2}, Lqf8;->e(I)Ljava/lang/String;
    ...
    invoke-direct {v2, v6, p2}, Lfla;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v6, v7, p2}, Lfla;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v4, p2}, Lfla;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v4, v5, p2}, Lfla;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v1, v2, v6, v3, v4}, [Lfla;
    ...
    :cond_a
    invoke-interface {p1}, Lppc;->f()Ljava/lang/Integer;
    ...
    :cond_b
    invoke-interface {p1}, Lppc;->getWidth()Ljava/lang/Integer;
    ...
    :cond_c
    invoke-interface {p1}, Lppc;->getHeight()Ljava/lang/Integer;
    ...
    invoke-interface {p1}, Lppc;->d()Landroid/net/Uri;
    ...
    invoke-interface {p1, v6, v4}, Lppc;->b(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    iget-object p0, p0, Lgf;->b:Landroid/content/Context;
    ...
    sget-object p1, Lnpc;->b:Ljava/lang/String;
