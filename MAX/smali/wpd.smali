...
.method public final l(Lu69;Ljava/nio/ByteBuffer;)Landroidx/media3/common/Metadata;
    ...
    iget-object v5, v0, Lwpd;->h:Ljne;

    if-eqz v5, :cond_0

    iget-wide v6, v1, Lu69;->k:J

    monitor-enter v5

    :try_start_0
    iget-wide v8, v5, Ljne;->b:J
    :try_end_0
    ...
    invoke-direct {v5, v6, v7}, Ljne;-><init>(J)V

    iput-object v5, v0, Lwpd;->h:Ljne;

    iget-wide v6, v1, Lx54;->g:J

    iget-wide v8, v1, Lu69;->k:J

    sub-long/2addr v6, v8

    invoke-virtual {v5, v6, v7}, Ljne;->a(J)J
    ...
    iget-object v6, v0, Lwpd;->f:Lqla;

    invoke-virtual {v6, v5, v1}, Lqla;->E(I[B)V

    iget-object v7, v0, Lwpd;->g:Lc12;
    ...
    :cond_2
    iget-object v0, v0, Lwpd;->h:Ljne;

    invoke-static {v8, v9, v6}, Landroidx/media3/extractor/metadata/scte35/TimeSignalCommand;->a(JLqla;)J

    move-result-wide v5

    invoke-virtual {v0, v5, v6}, Ljne;->b(J)J

    move-result-wide v0

    new-instance v3, Landroidx/media3/extractor/metadata/scte35/TimeSignalCommand;

    invoke-direct {v3, v5, v6, v0, v1}, Landroidx/media3/extractor/metadata/scte35/TimeSignalCommand;-><init>(JJ)V
    ...
    invoke-virtual {v0, v13, v14}, Ljne;->b(J)J
    ...
    invoke-direct/range {v29 .. v34}, Lypd;-><init>(IJJ)V
    ...
    invoke-virtual {v0, v1, v2}, Ljne;->b(J)J
    ...
    invoke-direct {v15, v14, v3, v4}, Laqd;-><init>(IJ)V
    ...
    invoke-direct/range {v41 .. v55}, Lcqd;-><init>(JZZZLjava/util/ArrayList;JZJIII)V
    ...
    invoke-virtual {v6, v0, v1, v15}, Lqla;->e(II[B)V
