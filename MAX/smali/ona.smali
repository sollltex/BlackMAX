...
.method public final dispatch(Lgx3;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p1}, Lix3;->isDispatchNeeded(Lgx3;)Z
    ...
    :cond_2
    iget-object p1, p0, Lnl4;->d:Ljava/util/ArrayDeque;
    ...
    invoke-direct {v1, p0, v2, p2}, Lhu1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v0, p1, v1}, Lix3;->dispatch(Lgx3;Ljava/lang/Runnable;)V
...
.method public final isDispatchNeeded(Lgx3;)Z
    ...
    iget-boolean p1, p0, Lnl4;->b:Z

    if-nez p1, :cond_2

    iget-boolean p0, p0, Lnl4;->a:Z
