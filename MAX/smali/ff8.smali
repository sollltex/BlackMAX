...
.method static constructor <clinit>()V
    ...
    sget v0, Lznb;->mr_dynamic_dialog_icon_light:I
...
.method public static a(Landroid/content/Context;Z)Landroid/view/ContextThemeWrapper;
    ...
    sget p1, Lrnb;->dialogTheme:I

    goto :goto_0

    :cond_0
    sget p1, Lrnb;->alertDialogTheme:I

    :goto_0
    invoke-static {p1, p0}, Lff8;->h(ILandroid/content/Context;)I
    ...
    sget p0, Lmnb;->mediaRouteTheme:I

    invoke-static {p0, v0}, Lff8;->h(ILandroid/content/Context;)I
    ...
    invoke-static {v0}, Lff8;->f(Landroid/content/Context;)I
...
.method public static b(Landroid/view/ContextThemeWrapper;)I
    ...
    sget v0, Lmnb;->mediaRouteTheme:I

    invoke-static {v0, p0}, Lff8;->h(ILandroid/content/Context;)I

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lff8;->f(Landroid/content/Context;)I
...
.method public static c(Landroid/content/Context;)I
    ...
    sget v0, Lrnb;->colorPrimary:I

    invoke-static {v0, p0}, Lff8;->g(ILandroid/content/Context;)I

    move-result p0

    const/4 v0, -0x1

    invoke-static {v0, p0}, Lw63;->d(II)D
...
.method public static f(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lff8;->c(Landroid/content/Context;)I

    move-result p0

    if-ne p0, v1, :cond_0

    sget p0, Lexb;->Theme_MediaRouter_Light:I

    goto :goto_0

    :cond_0
    sget p0, Lexb;->Theme_MediaRouter_Light_DarkControlPanel:I
    ...
    sget p0, Lexb;->Theme_MediaRouter_LightControlPanel:I

    goto :goto_0

    :cond_2
    sget p0, Lexb;->Theme_MediaRouter:I
...
.method public static j(Landroid/content/Context;Landroid/widget/ProgressBar;)V
    ...
    sget v0, Lznb;->mr_cast_progressbar_progress_and_thumb_light:I

    goto :goto_0

    :cond_1
    sget v0, Lznb;->mr_cast_progressbar_progress_and_thumb_dark:I
