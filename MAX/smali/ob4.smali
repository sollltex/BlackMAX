...
# direct methods
.method public constructor <init>(Ljava/lang/String;IIZLph4;)V
    .locals 1
    ...
    iput-object p1, p0, Lob4;->i:Ljava/lang/String;

    iput p2, p0, Lob4;->g:I

    iput p3, p0, Lob4;->h:I

    iput-boolean p4, p0, Lob4;->e:Z

    const/4 p1, 0x0

    iput-boolean p1, p0, Lob4;->f:Z

    iput-object p5, p0, Lob4;->j:Lph4;

    const/4 p2, 0x0

    iput-object p2, p0, Lob4;->l:Lk2b;

    new-instance p2, Lph4;

    const/16 p3, 0x15

    invoke-direct {p2, p3}, Lph4;-><init>(I)V

    iput-object p2, p0, Lob4;->k:Lph4;

    iput-boolean p1, p0, Lob4;->m:Z
...
.method public final F(Lm34;)J
    ...
    iput-wide v2, v1, Lob4;->s:J

    iput-wide v2, v1, Lob4;->r:J
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p1}, Lob4;->i(Lm34;)Ljava/net/HttpURLConnection;

    move-result-object v5

    iput-object v5, v1, Lob4;->n:Ljava/net/HttpURLConnection;
    ...
    iget-object v15, v1, Lob4;->l:Lk2b;

    if-eqz v15, :cond_3

    invoke-interface {v15, v6}, Lk2b;->apply(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual/range {p0 .. p0}, Lob4;->f()V

    new-instance v0, Landroidx/media3/datasource/HttpDataSource$InvalidContentTypeException;

    const-string v1, "Invalid content type: "

    invoke-static {v1, v6}, Lbi0;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v13, Llp6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v9}, Lj36;->t(Ljava/lang/String;)V
    ...
    sget-object v14, Llp6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v2}, Lj36;->t(Ljava/lang/String;)V
    ...
    iput-object v3, v1, Lob4;->o:Ljava/io/InputStream;

    if-eqz v6, :cond_b

    new-instance v3, Ljava/util/zip/GZIPInputStream;

    iget-object v5, v1, Lob4;->o:Ljava/io/InputStream;
    ...
    :cond_b
    :goto_7
    iput-boolean v4, v1, Lob4;->p:Z

    invoke-virtual/range {p0 .. p1}, Lxi0;->e(Lm34;)V

    :try_start_4
    invoke-virtual {v1, v11, v12}, Lob4;->l(J)V
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_3

    iget-wide v0, v1, Lob4;->r:J
    ...
    sget-object v7, Llp6;->a:Ljava/util/regex/Pattern;
    ...
    :cond_e
    sget-object v7, Llp6;->b:Ljava/util/regex/Pattern;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Lob4;->o:Ljava/io/InputStream;

    if-eqz v2, :cond_1

    iget-wide v3, p0, Lob4;->r:J
    ...
    :cond_0
    iget-wide v5, p0, Lob4;->s:J

    sub-long v5, v3, v5

    :goto_0
    iget-object v3, p0, Lob4;->n:Ljava/net/HttpURLConnection;

    invoke-static {v3, v5, v6}, Lob4;->k(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    ...
    :cond_1
    :goto_1
    iput-object v1, p0, Lob4;->o:Ljava/io/InputStream;

    invoke-virtual {p0}, Lob4;->f()V

    iget-boolean v1, p0, Lob4;->p:Z

    if-eqz v1, :cond_2

    iput-boolean v0, p0, Lob4;->p:Z
...
.method public final f()V
    ...
    iget-object v0, p0, Lob4;->n:Ljava/net/HttpURLConnection;
    ...
    iput-object v0, p0, Lob4;->n:Ljava/net/HttpURLConnection;

    :cond_0
    return-void
.end method

.method public final g(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
    .locals 4
    ...
    invoke-static {p1, p2}, Lbi0;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, Lob4;->n:Ljava/net/HttpURLConnection;
...
.method public final i(Lm34;)Ljava/net/HttpURLConnection;
    .locals 25
    ...
    iget-object v0, v12, Lm34;->a:Landroid/net/Uri;
    ...
    :goto_0
    iget-boolean v0, v11, Lob4;->e:Z

    iget-boolean v15, v11, Lob4;->m:Z

    iget v3, v12, Lm34;->c:I

    iget-object v4, v12, Lm34;->d:[B

    iget-wide v9, v12, Lm34;->f:J

    iget-wide v6, v12, Lm34;->g:J

    if-nez v0, :cond_1

    iget-boolean v0, v11, Lob4;->f:Z
    ...
    iget-object v12, v12, Lm34;->e:Ljava/util/Map;
    ...
    invoke-virtual/range {v0 .. v10}, Lob4;->j(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v3, v12, Lm34;->e:Ljava/util/Map;
    ...
    :goto_3
    invoke-virtual {v11, v1, v2}, Lob4;->g(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-static {v3, v2}, Lgj6;->j(ILjava/lang/String;)Ljava/lang/String;
...
.method public final j(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lob4;->j:Lph4;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lph4;->v()Ljava/util/Map;
    ...
    :cond_1
    sget-object p10, Llp6;->a:Ljava/util/regex/Pattern;
    ...
    :cond_4
    iget-object p0, p0, Lob4;->i:Ljava/lang/String;
...
.method public final l(J)V
    ...
    iget-object v5, p0, Lob4;->o:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, Lxi0;->a(I)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Lob4;->o:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Lob4;->s:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lob4;->s:J
