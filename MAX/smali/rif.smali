...
.method public static b(Ljava/util/List;)Landroidx/media3/common/Metadata;
    ...
    invoke-direct {v5, v4}, Lqla;-><init>([B)V

    invoke-static {v5}, Landroidx/media3/extractor/metadata/flac/PictureFrame;->a(Lqla;)Landroidx/media3/extractor/metadata/flac/PictureFrame;
    ...
    invoke-static {v5, v4}, Lj36;->c0(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static c(Lqla;ZZ)Looa;
    .locals 5
    ...
    invoke-static {p1, p0, v0}, Lrif;->d(ILqla;Z)Z

    :cond_0
    invoke-virtual {p0}, Lqla;->l()J
    ...
    invoke-virtual {p0, p1, v1}, Lqla;->s(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v4}, Lqla;->s(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    :cond_3
    :goto_1
    new-instance p0, Looa;

    const/16 p2, 0xd

    invoke-direct {p0, p2, p1}, Looa;-><init>(ILjava/lang/Object;)V

    return-object p0
.end method

.method public static d(ILqla;Z)Z
    .locals 4
