...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lg80;->m:J

    return-void
.end method

.method public constructor <init>(Lt90;Landroid/content/Context;)V
    .locals 9
    ...
    iput-object v0, p0, Lg80;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lg80;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lg80;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Lg80;->l:Z
    ...
    invoke-static {v0, p1, p2}, Lg80;->c(ILt90;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Lg80;->a:Landroid/media/AudioRecord;
...
.method public static c(ILt90;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4
    ...
    invoke-static {v2, p2}, Lcm;->c(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
...
.method public final a(Lzkd;Lc1d;)V
    ...
    iget-object v0, p0, Lg80;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0}, Lg80;->b()V

    iput-object p1, p0, Lg80;->h:Lzkd;

    iput-object p2, p0, Lg80;->i:Ljava/util/concurrent/Executor;

    iget-object p1, p0, Lg80;->k:Lf80;

    if-eqz p1, :cond_0

    iget-object v0, p0, Lg80;->a:Landroid/media/AudioRecord;
    ...
    invoke-direct {p1, p0}, Lf80;-><init>(Lg80;)V

    iput-object p1, p0, Lg80;->k:Lf80;

    :cond_1
    iget-object p1, p0, Lg80;->a:Landroid/media/AudioRecord;

    iget-object p0, p0, Lg80;->k:Lf80;
...
.method public final b()V
    ...
    iget-object p0, p0, Lg80;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final d(Z)V
    ...
    iget-object v0, p0, Lg80;->i:Ljava/util/concurrent/Executor;

    iget-object v1, p0, Lg80;->h:Lzkd;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object p0, p0, Lg80;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p0, v1, p1, v2}, Lt70;-><init>(Ljava/lang/Object;ZI)V
...
.method public final read(Ljava/nio/ByteBuffer;)Lw90;
    ...
    iget-object v5, p0, Lg80;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Lg80;->b:Lt90;

    iget v5, v5, Lt90;->b:I

    iget-wide v7, p0, Lg80;->j:J
    ...
    invoke-static {v11, v9}, Lo2g;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {v5, v7, v8}, Lvu0;->l(IJ)J
    ...
    sget-wide v7, Lg80;->m:J

    cmp-long p1, v5, v7

    if-lez p1, :cond_4

    iput-boolean v10, p0, Lg80;->l:Z
    ...
    :cond_5
    iget-wide v3, p0, Lg80;->j:J

    int-to-long v5, v0

    iget p1, p0, Lg80;->g:I

    invoke-static {p1, v5, v6}, Lvu0;->G(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Lg80;->j:J

    :cond_6
    new-instance p0, Lw90;

    invoke-direct {p0, v0, v1, v2}, Lw90;-><init>(IJ)V
...
.method public final release()V
    ...
    iget-object v0, p0, Lg80;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    iget-object v0, p0, Lg80;->k:Lf80;

    if-eqz v0, :cond_1

    iget-object v1, p0, Lg80;->a:Landroid/media/AudioRecord;
    ...
    :cond_1
    iget-object p0, p0, Lg80;->a:Landroid/media/AudioRecord;
...
.method public final start()V
    ...
    iget-object v2, p0, Lg80;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Lg80;->j:J

    iput-boolean v4, p0, Lg80;->l:Z

    iget-object v0, p0, Lg80;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :goto_1
    invoke-virtual {p0, v1}, Lg80;->d(Z)V
...
.method public final stop()V
    ...
    iget-object v0, p0, Lg80;->b:Lt90;

    const/4 v1, 0x0

    iget v2, p0, Lg80;->f:I

    invoke-static {v2, v0, v1}, Lg80;->c(ILt90;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object v0

    iput-object v0, p0, Lg80;->a:Landroid/media/AudioRecord;
