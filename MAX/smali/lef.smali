...
.method public static b(Landroid/view/View;Lnyf;Landroid/graphics/Rect;)Lnyf;
    .locals 1
...
.method public static j(Landroid/view/View;)Lnyf;
    .locals 7

    sget-boolean v0, Lcyf;->d:Z
    ...
    :try_start_0
    sget-object v2, Lcyf;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Lcyf;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Lcyf;->c:Ljava/lang/reflect/Field;
    ...
    invoke-static {v4, v5, v6, v2}, Ln17;->b(IIII)Ln17;

    move-result-object v2

    invoke-virtual {v3, v2}, Ldyf;->i(Ln17;)V
    ...
    invoke-static {v2, v4, v5, v0}, Ln17;->b(IIII)Ln17;

    move-result-object v0

    invoke-virtual {v3, v0}, Ldyf;->f(Ln17;)V

    invoke-virtual {v3}, Ldyf;->b()Lnyf;

    move-result-object v0

    iget-object v2, v0, Lnyf;->a:Llyf;

    invoke-virtual {v2, v0}, Llyf;->q(Lnyf;)V
    ...
    invoke-virtual {v2, p0}, Llyf;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;Lsz9;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, Lkef;-><init>(Landroid/view/View;Lsz9;)V
