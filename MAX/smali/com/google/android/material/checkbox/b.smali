...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/android/material/checkbox/b;->y:I

    sget v0, Lpnb;->state_indeterminate:I

    filled-new-array {v0}, [I

    move-result-object v0

    sput-object v0, Lcom/google/android/material/checkbox/b;->z:[I

    sget v0, Lpnb;->state_error:I
    ...
    sput-object v0, Lcom/google/android/material/checkbox/b;->B:[[I
    ...
    sput v0, Lcom/google/android/material/checkbox/b;->O0:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v6, Lpnb;->checkboxStyle:I

    sget v7, Lcom/google/android/material/checkbox/b;->y:I
    ...
    invoke-direct {v1, p1}, Lbh;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v2, v0, p1}, Lpdc;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, v1, Lr3f;->a:Landroid/graphics/drawable/Drawable;

    iget-object v0, v1, Lbh;->f:Lyg;

    invoke-virtual {p1, v0}, Landroid/graphics/drawable/Drawable;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    new-instance p1, Lah;

    iget-object v0, v1, Lr3f;->a:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;

    move-result-object v0

    invoke-direct {p1, v0}, Lah;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object v1, p0, Lcom/google/android/material/checkbox/b;->w:Lbh;

    new-instance p1, Ldk0;

    const/4 v0, 0x2

    invoke-direct {p1, p0, v0}, Ldk0;-><init>(Landroid/view/View;I)V

    iput-object p1, p0, Lcom/google/android/material/checkbox/b;->x:Ldk0;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    invoke-static {p0}, Lcd3;->a(Landroid/widget/CompoundButton;)Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lcom/google/android/material/checkbox/b;->o:Landroid/content/res/ColorStateList;

    const/4 v8, 0x0

    invoke-interface {p0, v8}, Lone;->setSupportButtonTintList(Landroid/content/res/ColorStateList;)V

    sget-object v9, Lrxb;->MaterialCheckBox:[I
    ...
    invoke-direct {v0, p1, p2}, Llw4;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    sget v1, Lrxb;->MaterialCheckBox_buttonIcon:I

    invoke-virtual {v0, v1}, Llw4;->f(I)Landroid/graphics/drawable/Drawable;
    ...
    sget v1, Lpnb;->isMaterial3Theme:I

    invoke-static {v1, p1, v10}, Lwc7;->L(ILandroid/content/Context;Z)Z

    move-result v1

    if-eqz v1, :cond_0

    sget v1, Lrxb;->MaterialCheckBox_android_button:I

    invoke-virtual {p2, v1, v10}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    sget v3, Lrxb;->MaterialCheckBox_buttonCompat:I

    invoke-virtual {p2, v3, v10}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v3

    sget v4, Lcom/google/android/material/checkbox/b;->O0:I
    ...
    sget v1, Lspb;->mtrl_checkbox_button:I

    invoke-static {p1, v1}, Ldw7;->x(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/material/checkbox/b;->l:Landroid/graphics/drawable/Drawable;

    iput-boolean v2, p0, Lcom/google/android/material/checkbox/b;->n:Z

    iget-object v1, p0, Lcom/google/android/material/checkbox/b;->m:Landroid/graphics/drawable/Drawable;

    if-nez v1, :cond_0

    sget v1, Lspb;->mtrl_checkbox_button_icon:I
    ...
    :cond_0
    sget v1, Lrxb;->MaterialCheckBox_buttonIconTint:I

    invoke-static {p1, v0, v1}, Law7;->A(Landroid/content/Context;Llw4;I)Landroid/content/res/ColorStateList;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/checkbox/b;->p:Landroid/content/res/ColorStateList;

    sget p1, Lrxb;->MaterialCheckBox_buttonIconTintMode:I
    ...
    invoke-static {p1, v1}, Lcp3;->H(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/checkbox/b;->q:Landroid/graphics/PorterDuff$Mode;

    sget p1, Lrxb;->MaterialCheckBox_useMaterialThemeColors:I
    ...
    sget p1, Lrxb;->MaterialCheckBox_centerIfNoTextEnabled:I
    ...
    sget p1, Lrxb;->MaterialCheckBox_errorShown:I
    ...
    sget p1, Lrxb;->MaterialCheckBox_errorAccessibilityLabel:I
    ...
    sget p1, Lrxb;->MaterialCheckBox_checkedState:I
    ...
    :cond_1
    invoke-virtual {v0}, Llw4;->m()V

    invoke-virtual {p0}, Lcom/google/android/material/checkbox/b;->b()V
...
.method private getMaterialThemeColorsTintList()Landroid/content/res/ColorStateList;
    ...
    sget v3, Lpnb;->colorOnSurface:I

    invoke-static {p0, v3}, Lgp7;->n(Landroid/view/View;I)I
    ...
    invoke-static {v2, v4, v0}, Lgp7;->u(IFI)I

    move-result v0

    const v4, 0x3f0a3d71    # 0.54f

    invoke-static {v2, v4, v3}, Lgp7;->u(IFI)I

    move-result v4

    const v5, 0x3ec28f5c    # 0.38f

    invoke-static {v2, v5, v3}, Lgp7;->u(IFI)I
...
.method private getSuperButtonTintList()Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-interface {p0}, Lone;->getSupportButtonTintList()Landroid/content/res/ColorStateList;
...
.method public final b()V
    ...
    invoke-static {p0}, Lbd3;->b(Landroid/widget/CompoundButton;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_4
    iget-object v0, p0, Lcom/google/android/material/checkbox/b;->w:Lbh;

    if-eqz v0, :cond_f

    iget-object v1, v0, Lr3f;->a:Landroid/graphics/drawable/Drawable;

    iget-object v2, p0, Lcom/google/android/material/checkbox/b;->x:Ldk0;

    if-eqz v1, :cond_6

    check-cast v1, Landroid/graphics/drawable/AnimatedVectorDrawable;

    iget-object v4, v2, Luf;->a:Ltf;

    if-nez v4, :cond_5

    new-instance v4, Ltf;

    invoke-direct {v4, v2}, Ltf;-><init>(Luf;)V

    iput-object v4, v2, Luf;->a:Ltf;
    ...
    :cond_6
    iget-object v1, v0, Lbh;->e:Ljava/util/ArrayList;

    iget-object v4, v0, Lbh;->b:Lzg;
    ...
    iget-object v3, v2, Luf;->a:Ltf;

    if-nez v3, :cond_9

    new-instance v3, Ltf;

    invoke-direct {v3, v2}, Ltf;-><init>(Luf;)V

    iput-object v3, v2, Luf;->a:Ltf;

    :cond_9
    iget-object v2, v2, Luf;->a:Ltf;
    ...
    iput-object v1, v0, Lbh;->e:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v2, v0}, Lj7;-><init>(ILjava/lang/Object;)V

    iput-object v1, v0, Lbh;->d:Lj7;

    :cond_e
    iget-object v1, v4, Lzg;->b:Landroid/animation/AnimatorSet;

    iget-object v2, v0, Lbh;->d:Lj7;
    ...
    sget v2, Ldqb;->checked:I

    sget v3, Ldqb;->unchecked:I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {p0, v0, v1, v3, p1}, Lbq4;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public setButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, Lone;->setSupportButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
