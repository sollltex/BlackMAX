...
.field public v:Lcom/google/android/material/datepicker/PickerFragment;

.field public w:Lcom/google/android/material/datepicker/CalendarConstraints;

.field public x:Lcom/google/android/material/datepicker/MaterialCalendar;
...
.method public static f0(Landroid/content/Context;)I
    ...
    invoke-static {}, Lt2f;->c()Ljava/util/Calendar;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/google/android/material/datepicker/Month;-><init>(Ljava/util/Calendar;)V

    sget v2, Loob;->mtrl_calendar_day_width:I

    invoke-virtual {p0, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v2

    sget v3, Loob;->mtrl_calendar_month_horizontal_padding:I
...
.method public static g0(ILandroid/content/Context;)Z
    .locals 2
...
.method public final a0()Landroid/app/Dialog;
    ...
    invoke-static {v2, v1}, Lcom/google/android/material/datepicker/MaterialDatePicker;->g0(ILandroid/content/Context;)Z

    move-result v2

    iput-boolean v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->A:Z

    new-instance v2, Liz7;

    sget v4, Lpnb;->materialCalendarStyle:I

    sget v5, Lfxb;->Widget_MaterialComponents_MaterialCalendar:I

    invoke-direct {v2, v1, v3, v4, v5}, Liz7;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->V0:Liz7;

    sget-object v2, Lrxb;->MaterialCalendar:[I
    ...
    sget v3, Lrxb;->MaterialCalendar_backgroundTint:I
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->V0:Liz7;

    invoke-virtual {v2, v1}, Liz7;->j(Landroid/content/Context;)V

    iget-object v1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->V0:Liz7;
    ...
    iget-object p0, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->V0:Liz7;
    ...
    invoke-virtual {p0, v1}, Liz7;->k(F)V

    return-object v0

    :cond_0
    invoke-virtual {p0}, Lcom/google/android/material/datepicker/MaterialDatePicker;->e0()V
...
.method public final e0()V
    ...
    invoke-static {p0}, Lgj6;->p(Landroid/os/Parcelable;)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->w:Lcom/google/android/material/datepicker/CalendarConstraints;
    ...
    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->z:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->O0:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->S0:Ljava/lang/CharSequence;
    ...
    :cond_3
    :goto_1
    iput-object p1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->Y0:Ljava/lang/CharSequence;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-boolean p3, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->A:Z

    if-eqz p3, :cond_0

    sget p3, Lptb;->mtrl_picker_fullscreen:I

    goto :goto_0

    :cond_0
    sget p3, Lptb;->mtrl_picker_dialog:I
    ...
    sget p3, Ldqb;->mtrl_calendar_frame:I
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/MaterialDatePicker;->f0(Landroid/content/Context;)I
    ...
    :cond_1
    sget p3, Ldqb;->mtrl_calendar_main_pane:I
    ...
    :goto_1
    sget p3, Ldqb;->mtrl_picker_header_selection_text:I
    ...
    sget p3, Ldqb;->mtrl_picker_header_toggle:I
    ...
    sget p3, Ldqb;->mtrl_picker_title_text:I
    ...
    iget-object p3, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->U0:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    sget v3, Lspb;->material_ic_calendar_black_24dp:I

    invoke-static {p2, v3}, Ldw7;->x(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v4, Lspb;->material_ic_edit_black_24dp:I

    invoke-static {p2, v4}, Ldw7;->x(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->U0:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-static {p2, p3}, Lwef;->j(Landroid/view/View;Lz4;)V
...
.method public final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget v3, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->u:I
    ...
    iget-object v4, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->w:Lcom/google/android/material/datepicker/CalendarConstraints;
    ...
    iget-object v9, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->x:Lcom/google/android/material/datepicker/MaterialCalendar;
    ...
    iget v3, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->y:I

    invoke-virtual {v1, v2, v3}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    const-string v2, "TITLE_TEXT_KEY"

    iget-object v3, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->z:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2, v3}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string v2, "INPUT_MODE_KEY"

    iget v3, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->B:I
    ...
    iget-object v3, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->O0:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2, v3}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string v2, "NEGATIVE_BUTTON_TEXT_RES_ID_KEY"

    iget v3, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->P0:I

    invoke-virtual {v1, v2, v3}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    const-string v2, "NEGATIVE_BUTTON_TEXT_KEY"

    iget-object v3, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->Q0:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2, v3}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string v2, "NEGATIVE_BUTTON_CONTENT_DESCRIPTION_RES_ID_KEY"

    iget v3, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->R0:I

    invoke-virtual {v1, v2, v3}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    const-string v2, "NEGATIVE_BUTTON_CONTENT_DESCRIPTION_KEY"

    iget-object v0, v0, Lcom/google/android/material/datepicker/MaterialDatePicker;->S0:Ljava/lang/CharSequence;
...
.method public final onStart()V
    ...
    iget-boolean v1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->A:Z
    ...
    iget-boolean v1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->W0:Z
    ...
    sget v4, Ldqb;->fullscreen_header:I
    ...
    invoke-static {v4}, Lola;->p(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v7, v8, v9}, Lgp7;->l(Landroid/content/Context;II)I
    ...
    :cond_3
    invoke-static {v0, v5}, Lgp7;->A(Landroid/view/Window;Z)V
    ...
    invoke-static {v4}, Lgp7;->t(I)Z

    move-result v4

    invoke-static {v5}, Lgp7;->t(I)Z
    ...
    invoke-direct {v8, v6}, Ljkd;-><init>(Landroid/view/View;)V
    ...
    invoke-static {v0}, Lxxf;->h(Landroid/view/Window;)Landroid/view/WindowInsetsController;

    move-result-object v10

    invoke-direct {v6, v10, v8}, Lpyf;-><init>(Landroid/view/WindowInsetsController;Ljkd;)V

    iput-object v0, v6, Lpyf;->j:Landroid/view/Window;
    ...
    invoke-direct {v6, v0, v8}, Loyf;-><init>(Landroid/view/Window;Ljkd;)V

    :goto_5
    invoke-virtual {v6, v4}, Law7;->U(Z)V

    invoke-static {v7}, Lgp7;->t(I)Z
    ...
    invoke-direct {v6, v4}, Ljkd;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v4, v7, v6}, Lpyf;-><init>(Landroid/view/WindowInsetsController;Ljkd;)V

    iput-object v0, v4, Lpyf;->j:Landroid/view/Window;
    ...
    invoke-direct {v4, v0, v6}, Loyf;-><init>(Landroid/view/Window;Ljkd;)V

    :goto_6
    invoke-virtual {v4, v5}, Law7;->T(Z)V
    ...
    invoke-direct {v5, v1, v4, v0, v6}, Lfz9;-><init>(Ljava/lang/Object;III)V

    sget-object v0, Lwef;->a:Ljava/util/WeakHashMap;

    invoke-static {v1, v5}, Llef;->u(Landroid/view/View;Lsz9;)V

    iput-boolean v3, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->W0:Z
    ...
    sget v4, Loob;->mtrl_calendar_dialog_background_inset:I
    ...
    iget-object v6, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->V0:Liz7;
    ...
    invoke-direct {v4, v5, v1}, Ll17;-><init>(Landroid/app/Dialog;Landroid/graphics/Rect;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->w:Lcom/google/android/material/datepicker/CalendarConstraints;
    ...
    iput-object v4, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->x:Lcom/google/android/material/datepicker/MaterialCalendar;
    ...
    :cond_c
    iput-object v4, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->v:Lcom/google/android/material/datepicker/PickerFragment;

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->T0:Landroid/widget/TextView;
...
.method public final onStop()V
    ...
    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->v:Lcom/google/android/material/datepicker/PickerFragment;
