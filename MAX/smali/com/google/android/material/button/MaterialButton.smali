...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v6, Lpnb;->materialButtonStyle:I

    sget v7, Lcom/google/android/material/button/MaterialButton;->t:I

    invoke-static {p1, p2, v6, v7}, Lqz7;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    sget-object v2, Lrxb;->MaterialButton:[I
    ...
    sget v1, Lrxb;->MaterialButton_iconPadding:I
    ...
    sget v1, Lrxb;->MaterialButton_iconTintMode:I
    ...
    invoke-static {v1, v3}, Lcp3;->H(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    sget v4, Lrxb;->MaterialButton_iconTint:I

    invoke-static {v1, v0, v4}, Law7;->B(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    sget v4, Lrxb;->MaterialButton_icon:I

    invoke-static {v1, v0, v4}, Law7;->E(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->i:Landroid/graphics/drawable/Drawable;

    sget v1, Lrxb;->MaterialButton_iconGravity:I
    ...
    sget v1, Lrxb;->MaterialButton_iconSize:I
    ...
    invoke-static {v8, p2, v6, v7}, Lldd;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Ltzf;
    ...
    invoke-direct {v1, p0, p2}, Lyy7;-><init>(Lcom/google/android/material/button/MaterialButton;Lldd;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lyy7;

    sget p2, Lrxb;->MaterialButton_android_insetLeft:I
    ...
    sget p2, Lrxb;->MaterialButton_android_insetRight:I
    ...
    sget p2, Lrxb;->MaterialButton_android_insetTop:I
    ...
    sget p2, Lrxb;->MaterialButton_android_insetBottom:I
    ...
    sget p2, Lrxb;->MaterialButton_cornerRadius:I
    ...
    iget-object v5, v1, Lyy7;->b:Lldd;

    int-to-float p2, p2

    invoke-virtual {v5}, Lldd;->e()Ltzf;

    move-result-object v5

    new-instance v6, Lc1;

    invoke-direct {v6, p2}, Lc1;-><init>(F)V

    iput-object v6, v5, Ltzf;->e:Ljava/lang/Object;

    new-instance v6, Lc1;

    invoke-direct {v6, p2}, Lc1;-><init>(F)V

    iput-object v6, v5, Ltzf;->f:Ljava/lang/Object;

    new-instance v6, Lc1;

    invoke-direct {v6, p2}, Lc1;-><init>(F)V

    iput-object v6, v5, Ltzf;->g:Ljava/lang/Object;

    new-instance v6, Lc1;

    invoke-direct {v6, p2}, Lc1;-><init>(F)V

    iput-object v6, v5, Ltzf;->h:Ljava/lang/Object;

    invoke-virtual {v5}, Ltzf;->c()Lldd;

    move-result-object p2

    invoke-virtual {v1, p2}, Lyy7;->c(Lldd;)V

    iput-boolean v4, v1, Lyy7;->p:Z

    :cond_0
    sget p2, Lrxb;->MaterialButton_strokeWidth:I
    ...
    sget p2, Lrxb;->MaterialButton_backgroundTintMode:I

    invoke-virtual {v0, p2, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p2

    invoke-static {p2, v3}, Lcp3;->H(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, v1, Lyy7;->i:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p2

    sget v2, Lrxb;->MaterialButton_backgroundTint:I

    invoke-static {p2, v0, v2}, Law7;->B(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v1, Lyy7;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p2

    sget v2, Lrxb;->MaterialButton_strokeColor:I

    invoke-static {p2, v0, v2}, Law7;->B(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v1, Lyy7;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p2

    sget v2, Lrxb;->MaterialButton_rippleColor:I

    invoke-static {p2, v0, v2}, Law7;->B(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v1, Lyy7;->l:Landroid/content/res/ColorStateList;

    sget p2, Lrxb;->MaterialButton_android_checkable:I

    invoke-virtual {v0, p2, p1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p2

    iput-boolean p2, v1, Lyy7;->q:Z

    sget p2, Lrxb;->MaterialButton_elevation:I
    ...
    sget p2, Lrxb;->MaterialButton_toggleCheckedStateOnClick:I

    invoke-virtual {v0, p2, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p2

    iput-boolean p2, v1, Lyy7;->r:Z
    ...
    sget v6, Lrxb;->MaterialButton_android_background:I
    ...
    iput-boolean v4, v1, Lyy7;->o:Z

    iget-object v6, v1, Lyy7;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, v1, Lyy7;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final b()Z
    ...
    iget-object p0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lyy7;

    if-eqz p0, :cond_0

    iget-boolean p0, p0, Lyy7;->q:Z
...
.method public final e(Z)V
    ...
    invoke-static {v0, v2}, Lbq4;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2, v0}, Lbq4;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Lyy7;->l:Landroid/content/res/ColorStateList;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Lyy7;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Lyy7;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, Lyy7;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:Lyy7;

    invoke-virtual {v1, v0}, Lyy7;->b(Z)Liz7;
...
.method public final performClick()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lyy7;

    iget-boolean v0, v0, Lyy7;->r:Z
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {p0, p1}, Liz7;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, v1, Lyy7;->o:Z

    iget-object v0, v1, Lyy7;->j:Landroid/content/res/ColorStateList;

    iget-object v2, v1, Lyy7;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    iget-object v0, v1, Lyy7;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerRadius(I)V
    ...
    invoke-virtual {p0, p1}, Lyy7;->c(Lldd;)V
...
.method public setInsetBottom(I)V
    ...
    invoke-virtual {p0, v0, p1}, Lyy7;->d(II)V
...
.method public setInsetTop(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lyy7;->d(II)V
...
.method public setOnPressedChangeListenerInternal(Lxy7;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->f:Lxy7;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->f:Lxy7;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lyy7;->l:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, Lyy7;->l:Landroid/content/res/ColorStateList;
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    iput-boolean p1, p0, Lyy7;->n:Z

    invoke-virtual {p0}, Lyy7;->f()V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lyy7;->k:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Lyy7;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lyy7;->j:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, Lyy7;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Lyy7;->b(Z)Liz7;
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v0, p0, Lyy7;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, Lyy7;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p1, p0}, Lbq4;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
