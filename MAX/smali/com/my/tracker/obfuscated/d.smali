...
.method private a(ILcom/my/tracker/obfuscated/p0;Ljava/lang/String;Loq;)V
    .locals 1
    ...
    .line 4
    :cond_0
    iget-object p1, p4, Loq;->a:Ljava/lang/String;
...
.method public static synthetic a(Lcom/my/tracker/obfuscated/d;ILcom/my/tracker/obfuscated/p0;Ljava/lang/String;Loq;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/my/tracker/obfuscated/d;->a(ILcom/my/tracker/obfuscated/p0;Ljava/lang/String;Loq;)V
...
.method private b(Landroid/content/Context;)V
    ...
    invoke-direct {v4, p1}, Lheb;-><init>(Landroid/content/Context;)V

    iget-object p1, v4, Lheb;->b:Ljava/lang/Object;

    check-cast p1, Lj7g;

    iget-object v5, p1, Lj7g;->j:Lbd6;

    iget-object v6, p1, Lj7g;->i:Landroid/content/Context;

    const v7, 0xcaf1200

    invoke-virtual {v5, v7, v6}, Lbd6;->b(ILandroid/content/Context;)I
    ...
    invoke-direct {v5, v6}, Li;-><init>(I)V

    const/4 v6, 0x1

    iput-boolean v6, v5, Li;->c:Z

    const/4 v6, 0x0

    iput v6, v5, Li;->b:I

    sget-object v7, Lt6g;->a:Lcom/google/android/gms/common/Feature;

    filled-new-array {v7}, [Lcom/google/android/gms/common/Feature;

    move-result-object v7

    iput-object v7, v5, Li;->e:Ljava/lang/Object;

    new-instance v7, Lv84;

    invoke-direct {v7, p1}, Lv84;-><init>(Lj7g;)V

    iput-object v7, v5, Li;->d:Ljava/lang/Object;
    ...
    invoke-virtual {p1, v6, v5}, Lzc6;->b(ILi;)Lo7g;
    ...
    invoke-direct {v5, v7, v6}, Lcom/google/android/gms/common/api/Status;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v5}, Lo7g;-><init>()V

    invoke-virtual {v5, p1}, Lo7g;->e(Ljava/lang/Exception;)V
    ...
    invoke-direct {v5, v6, v4}, Lfxd;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v4, Lfhe;->a:Li50;

    new-instance v6, Lo7g;

    invoke-direct {v6}, Lo7g;-><init>()V

    new-instance v7, Lw6g;

    invoke-direct {v7, v4, v5, v6}, Lw6g;-><init>(Li50;Lfxd;Lo7g;)V

    iget-object v4, p1, Lo7g;->b:Lbf;

    invoke-virtual {v4, v7}, Lbf;->s(Lk7g;)V

    invoke-virtual {p1}, Lo7g;->h()V

    new-instance p1, Lrc0;

    invoke-direct {p1, p0, v2, v0, v1}, Lrc0;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V

    new-instance v0, Lw6g;

    invoke-direct {v0, v3, p1}, Lw6g;-><init>(Ljava/util/concurrent/Executor;Lp0a;)V

    iget-object p1, v6, Lo7g;->b:Lbf;

    invoke-virtual {p1, v0}, Lbf;->s(Lk7g;)V

    invoke-virtual {v6}, Lo7g;->h()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
