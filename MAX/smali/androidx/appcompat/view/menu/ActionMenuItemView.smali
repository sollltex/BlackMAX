...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v2, Lhyb;->ActionMenuItemView:[I

    invoke-virtual {p1, p2, v2, v0, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lhyb;->ActionMenuItemView_android_minWidth:I
...
.method public final c(Lvo8;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lvo8;
    ...
    invoke-virtual {p1}, Lvo8;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lc8;

    if-nez p1, :cond_1

    new-instance p1, Lc8;

    invoke-direct {p1, p0}, Lc8;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lc8;
...
.method public final e()Z
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lvo8;

    invoke-virtual {p0}, Lvo8;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final k()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lvo8;
    ...
    iget-object v2, v2, Lvo8;->q:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lvo8;->e:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lvo8;->r:Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lvo8;

    iget-object v1, v0, Lvo8;->e:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, Lnpe;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_5

    :cond_6
    invoke-static {p0, v2}, Lnpe;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->j:Lmo8;

    if-eqz p1, :cond_0

    iget-object p0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Lvo8;

    invoke-interface {p1, p0}, Lmo8;->a(Lvo8;)Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lvo8;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lc8;
...
.method public setItemInvoker(Lmo8;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->j:Lmo8;
...
.method public setPopupCallback(Ld8;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Ld8;
