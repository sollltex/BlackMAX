...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lrnb;->listMenuViewStyle:I
    ...
    sget-object v2, Lhyb;->MenuView:[I

    const/4 v3, 0x0

    invoke-static {v1, p2, v2, v0, v3}, Llw4;->k(Landroid/content/Context;Landroid/util/AttributeSet;[III)Llw4;

    move-result-object p2

    sget v0, Lhyb;->MenuView_android_itemBackground:I

    invoke-virtual {p2, v0}, Llw4;->f(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p2, Llw4;->b:Ljava/lang/Object;
    ...
    sget v1, Lrnb;->dropDownListViewStyle:I
...
.method public final c(Lvo8;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lvo8;
    ...
    iget-object v0, p1, Lvo8;->n:Lno8;

    invoke-virtual {v0}, Lno8;->o()Z
    ...
    invoke-virtual {v0}, Lno8;->n()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-char v0, p1, Lvo8;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Lvo8;->h:C
    ...
    :goto_2
    iget-object v4, p1, Lvo8;->n:Lno8;

    invoke-virtual {v4}, Lno8;->n()Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lvo8;

    iget-object v4, v0, Lvo8;->n:Lno8;

    invoke-virtual {v4}, Lno8;->o()Z
    ...
    iget-char v0, v0, Lvo8;->j:C

    goto :goto_3

    :cond_3
    iget-char v0, v0, Lvo8;->h:C
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lvo8;

    iget-object v5, v4, Lvo8;->n:Lno8;

    invoke-virtual {v5}, Lno8;->n()Z

    move-result v5

    if-eqz v5, :cond_6

    iget-char v5, v4, Lvo8;->j:C

    goto :goto_6

    :cond_6
    iget-char v5, v4, Lvo8;->h:C
    ...
    :cond_7
    iget-object v6, v4, Lvo8;->n:Lno8;

    iget-object v7, v6, Lno8;->a:Landroid/content/Context;
    ...
    iget-object v9, v6, Lno8;->a:Landroid/content/Context;
    ...
    sget v9, Lbxb;->abc_prepend_shortcut_label:I
    ...
    :goto_7
    sget v6, Lbxb;->abc_menu_meta_shortcut_label:I
    ...
    invoke-static {v4, v9, v6, v8}, Lvo8;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v6, Lbxb;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v6, Lbxb;->abc_menu_alt_shortcut_label:I
    ...
    sget v6, Lbxb;->abc_menu_shift_shortcut_label:I

    invoke-virtual {v7, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {v4, v3, v6, v8}, Lvo8;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v3, Lbxb;->abc_menu_sym_shortcut_label:I
    ...
    invoke-static {v4, v6, v3, v8}, Lvo8;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V

    sget v3, Lbxb;->abc_menu_function_shortcut_label:I

    invoke-virtual {v7, v3}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v3

    invoke-static {v4, v1, v3, v8}, Lvo8;->c(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    :cond_a
    sget v1, Lbxb;->abc_menu_space_shortcut_label:I
    ...
    :cond_b
    sget v1, Lbxb;->abc_menu_enter_shortcut_label:I
    ...
    :cond_c
    sget v1, Lbxb;->abc_menu_delete_shortcut_label:I
    ...
    iget-object p1, p1, Lvo8;->q:Ljava/lang/CharSequence;
...
.method public getItemData()Lvo8;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Lvo8;
...
.method public setCheckable(Z)V
    ...
    sget v3, Lttb;->abc_list_menu_item_radio:I
    ...
    sget v3, Lttb;->abc_list_menu_item_checkbox:I
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    sget v3, Lttb;->abc_list_menu_item_icon:I
