...
.field public static final P0:Lnyf;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v2, v1, v2}, Ln17;->b(IIII)Ln17;

    move-result-object v1

    invoke-virtual {v0, v1}, Lfyf;->f(Ln17;)V

    invoke-virtual {v0}, Lfyf;->b()Lnyf;

    move-result-object v0

    sput-object v0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->P0:Lnyf;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Lnyf;->b:Lnyf;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:Lnyf;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lnyf;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lnyf;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lnyf;

    new-instance p2, Lj7;

    const/4 v0, 0x0

    invoke-direct {p2, v0, p0}, Lj7;-><init>(ILjava/lang/Object;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lj7;

    new-instance p2, Lk7;

    invoke-direct {p2, p0, v0}, Lk7;-><init>(Landroidx/appcompat/widget/ActionBarOverlayLayout;I)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lk7;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lk7;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:Lw0g;

    new-instance p2, Ln7;

    const/4 v0, 0x0

    invoke-direct {p2, p1, v0}, Ln7;-><init>(Landroid/content/Context;I)V

    const/4 p1, 0x1

    invoke-virtual {p2, p1}, Landroid/view/View;->setWillNotDraw(Z)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Ln7;
...
.method public final b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lk7;

    invoke-virtual {p0, v0}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lk7;
...
.method public final e()V
    ...
    sget v0, Lhqb;->action_bar_activity_content:I
    ...
    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Ld64;
...
.method public final f(Landroid/view/Menu;Lhp8;)V
    .locals 3
    ...
    invoke-direct {v0, v2}, Lh8;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lmpe;->m:Lh8;

    :cond_0
    iget-object p0, p0, Lmpe;->m:Lh8;

    iput-object p2, p0, Lh8;->e:Lhp8;
    ...
    iget-object p2, p2, Landroidx/appcompat/widget/ActionMenuView;->a:Lno8;
    ...
    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->X0:Lh8;

    invoke-virtual {p2, v0}, Lno8;->r(Lip8;)V

    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->Y0:Lepe;

    invoke-virtual {p2, v0}, Lno8;->r(Lip8;)V

    :cond_3
    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->Y0:Lepe;

    if-nez p2, :cond_4

    new-instance p2, Lepe;

    invoke-direct {p2, v1}, Lepe;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object p2, v1, Landroidx/appcompat/widget/Toolbar;->Y0:Lepe;

    :cond_4
    const/4 p2, 0x1

    iput-boolean p2, p0, Lh8;->q:Z

    if-eqz p1, :cond_5

    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, p0, p2}, Lno8;->b(Lip8;Landroid/content/Context;)V

    iget-object p2, v1, Landroidx/appcompat/widget/Toolbar;->Y0:Lepe;

    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, p2, v0}, Lno8;->b(Lip8;Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, p2}, Lh8;->k(Landroid/content/Context;Lno8;)V

    iget-object p1, v1, Landroidx/appcompat/widget/Toolbar;->Y0:Lepe;

    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, v0, p2}, Lepe;->k(Landroid/content/Context;Lno8;)V

    invoke-virtual {p0}, Lh8;->i()V

    iget-object p1, v1, Landroidx/appcompat/widget/Toolbar;->Y0:Lepe;

    invoke-virtual {p1}, Lepe;->i()V
    ...
    invoke-virtual {p1, p0}, Landroidx/appcompat/widget/ActionMenuView;->setPresenter(Lh8;)V

    iput-object p0, v1, Landroidx/appcompat/widget/Toolbar;->X0:Lh8;
...
.method public getNestedScrollAxes()I
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:Lw0g;
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p0, p1}, Lnyf;->f(Landroid/view/View;Landroid/view/WindowInsets;)Lnyf;
    ...
    invoke-static {p0, p1, v1}, Llef;->b(Landroid/view/View;Lnyf;Landroid/graphics/Rect;)Lnyf;
    ...
    invoke-virtual {p1, v2, v3, v4, v5}, Llyf;->l(IIII)Lnyf;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:Lnyf;

    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lnyf;

    invoke-virtual {v3, v2}, Lnyf;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:Lnyf;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:Lnyf;
    ...
    :cond_2
    invoke-virtual {p1}, Llyf;->a()Lnyf;

    move-result-object p0

    iget-object p0, p0, Lnyf;->a:Llyf;

    invoke-virtual {p0}, Llyf;->c()Lnyf;

    move-result-object p0

    iget-object p0, p0, Lnyf;->a:Llyf;

    invoke-virtual {p0}, Llyf;->b()Lnyf;
...
.method public final onMeasure(II)V
    ...
    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->q:Lnyf;

    iput-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lnyf;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Ln7;

    sget-object v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->P0:Lnyf;

    iget-object v9, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->p:Landroid/graphics/Rect;

    invoke-static {v4, v7, v9}, Llef;->b(Landroid/view/View;Lnyf;Landroid/graphics/Rect;)Lnyf;

    sget-object v4, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Q0:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lnyf;

    iget-object v4, v4, Lnyf;->a:Llyf;

    invoke-virtual {v4, v2, v6, v2, v2}, Llyf;->l(IIII)Lnyf;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lnyf;

    goto :goto_3

    :cond_4
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lnyf;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lnyf;

    invoke-virtual {v6}, Lnyf;->c()I

    move-result v6

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lnyf;

    invoke-virtual {v7}, Lnyf;->a()I

    move-result v7

    invoke-static {v2, v4, v6, v7}, Ln17;->b(IIII)Ln17;
    ...
    invoke-direct {v6, v4}, Leyf;-><init>(Lnyf;)V
    ...
    invoke-direct {v6, v4}, Ldyf;-><init>(Lnyf;)V

    :goto_2
    invoke-virtual {v6, v2}, Ldyf;->f(Ln17;)V

    invoke-virtual {v6}, Ldyf;->b()Lnyf;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lnyf;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Lnyf;

    invoke-virtual {v2, v4}, Lnyf;->equals(Ljava/lang/Object;)Z
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t:Lnyf;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, Lwef;->b(Landroid/view/View;Lnyf;)Lnyf;
...
.method public final onNestedFling(Landroid/view/View;FFZ)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Lk7;

    invoke-virtual {p1}, Lk7;->run()V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lk7;
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:Lw0g;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Ll7;

    if-eqz p0, :cond_0

    check-cast p0, Ltxf;

    iget-object p1, p0, Ltxf;->s:Lpgf;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lpgf;->a()V
...
.method public final onWindowSystemUiVisibilityChanged(I)V
    ...
    :goto_1
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Ll7;
    ...
    iget-boolean p1, v4, Ltxf;->p:Z

    if-nez p1, :cond_4

    iput-boolean v3, v4, Ltxf;->p:Z

    invoke-virtual {v4, v3}, Ltxf;->s(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Ll7;
...
.method public setActionBarVisibilityCallback(Ll7;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Ll7;
...
.method public setIcon(I)V
    ...
    .line 6
    :goto_0
    iput-object p1, p0, Lmpe;->d:Landroid/graphics/drawable/Drawable;
...
.method public setLogo(I)V
    ...
    :goto_0
    iput-object p1, p0, Lmpe;->e:Landroid/graphics/drawable/Drawable;
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    iput-object p1, p0, Lmpe;->k:Landroid/view/Window$Callback;
