...
.method public static a(Lilc;[B)Lfu6;
    .locals 2
    ...
    invoke-virtual {p0}, Lilc;->getSurface()Landroid/view/Surface;
...
.method public static b(Lfu6;)Landroid/graphics/Bitmap;
    .locals 14
...
.method public static c(Lfu6;Lhu6;Ljava/nio/ByteBuffer;IZ)Lms6;
    .locals 18
    ...
    :cond_3
    :goto_1
    invoke-interface/range {p1 .. p1}, Lhu6;->getSurface()Landroid/view/Surface;
    ...
    invoke-virtual {v0}, Lye;->n()Ljava/nio/ByteBuffer;
    ...
    :cond_8
    invoke-interface/range {p1 .. p1}, Lhu6;->b()Lfu6;
    ...
    invoke-direct {v1, v0}, Lms6;-><init>(Lfu6;)V

    new-instance v2, Leu6;

    move-object/from16 v3, p0

    invoke-direct {v2, v0, v3}, Leu6;-><init>(Lfu6;Lfu6;)V

    invoke-virtual {v1, v2}, Lfz5;->a(Lez5;)V
