...
# direct methods
.method public constructor <init>(Lzs4;Landroid/graphics/SurfaceTexture;Z)V
    .locals 0

    invoke-direct {p0, p2}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object p1, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->b:Lzs4;
...
.method public static declared-synchronized a(Landroid/content/Context;)Z
    ...
    sget-object v6, Lz2f;->d:Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Z)Landroidx/media3/exoplayer/video/PlaceholderSurface;
    ...
    invoke-direct {p0, v2, v3}, Lzs4;-><init>(Ljava/lang/String;I)V
    ...
    iput-object v2, p0, Lzs4;->b:Landroid/os/Handler;

    new-instance v3, Llu4;

    const/4 v4, 0x1

    invoke-direct {v3, v2, v4}, Llu4;-><init>(Landroid/os/Handler;I)V

    iput-object v3, p0, Lzs4;->e:Ljava/lang/Object;

    monitor-enter p0

    :try_start_0
    iget-object v2, p0, Lzs4;->b:Landroid/os/Handler;
    ...
    :goto_3
    iget-object p1, p0, Lzs4;->f:Landroid/view/Surface;

    check-cast p1, Landroidx/media3/exoplayer/video/PlaceholderSurface;

    if-nez p1, :cond_3

    iget-object p1, p0, Lzs4;->d:Ljava/lang/RuntimeException;

    if-nez p1, :cond_3

    iget-object p1, p0, Lzs4;->c:Ljava/lang/Error;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object p0, p0, Lzs4;->f:Landroid/view/Surface;
...
.method public final release()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->b:Lzs4;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->b:Lzs4;

    iget-object v2, v1, Lzs4;->b:Landroid/os/Handler;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, v1, Lzs4;->b:Landroid/os/Handler;
