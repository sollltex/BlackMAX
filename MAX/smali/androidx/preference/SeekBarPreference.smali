...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lnnb;->seekBarPreferenceStyle:I

    invoke-direct {p0, p1, p2, v0}, Landroidx/preference/Preference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    sget-object v1, Lmxb;->SeekBarPreference:[I
    ...
    sget p2, Lmxb;->SeekBarPreference_min:I

    invoke-virtual {p1, p2, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p2

    sget v0, Lmxb;->SeekBarPreference_android_max:I
    ...
    :cond_1
    sget v0, Lmxb;->SeekBarPreference_seekBarIncrement:I
    ...
    :cond_2
    sget p0, Lmxb;->SeekBarPreference_adjustable:I

    const/4 p2, 0x1

    invoke-virtual {p1, p0, p2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    sget p0, Lmxb;->SeekBarPreference_showSeekBarValue:I

    invoke-virtual {p1, p0, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    sget p0, Lmxb;->SeekBarPreference_updatesContinuously:I
