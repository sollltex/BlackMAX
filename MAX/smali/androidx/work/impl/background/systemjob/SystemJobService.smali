...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lfeb;

    return-void
.end method

.method public static a(Landroid/app/job/JobParameters;)Lyyf;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Lyyf;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final b(Lyyf;Z)V
    ...
    iget-object v3, p1, Lyyf;->a:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lfeb;

    invoke-virtual {v0, p1}, Lfeb;->e(Lyyf;)Lqtd;
...
.method public final onCreate()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lezf;
    ...
    invoke-virtual {p0, v0, v1}, Lu17;->U(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lezf;
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lezf;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/SystemJobService;->a(Landroid/app/job/JobParameters;)Lyyf;
    ...
    invoke-virtual {p0, p1, v0}, Lu17;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, Lu17;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v0}, Lu17;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lpbe;->b(Landroid/app/job/JobParameters;)[Landroid/net/Uri;
    ...
    :cond_3
    invoke-static {p1}, Lpbe;->a(Landroid/app/job/JobParameters;)[Ljava/lang/String;
    ...
    iput-object v1, v0, Ltm7;->b:Ljava/lang/Object;

    :cond_4
    invoke-static {p1}, Lqbe;->a(Landroid/app/job/JobParameters;)Landroid/net/Network;

    move-result-object p1

    iput-object p1, v0, Ltm7;->d:Ljava/lang/Object;

    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lezf;

    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lfeb;

    invoke-virtual {p0, v2}, Lfeb;->g(Lyyf;)Lqtd;

    move-result-object p0

    invoke-virtual {p1, p0, v0}, Lezf;->h(Lqtd;Ltm7;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lu17;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lfeb;

    invoke-virtual {v2, p1}, Lfeb;->e(Lyyf;)Lqtd;

    move-result-object v2

    if-eqz v2, :cond_2

    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lezf;

    iget-object v4, v3, Lezf;->d:Lehe;

    new-instance v5, Lb2e;

    invoke-direct {v5, v3, v2, v0}, Lb2e;-><init>(Lezf;Lqtd;Z)V

    invoke-interface {v4, v5}, Lehe;->o(Ljava/lang/Runnable;)V

    :cond_2
    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lezf;

    iget-object p0, p0, Lezf;->f:Lb5b;

    iget-object p1, p1, Lyyf;->a:Ljava/lang/String;
    ...
    :try_start_1
    iget-object p0, p0, Lb5b;->j:Ljava/util/HashSet;
