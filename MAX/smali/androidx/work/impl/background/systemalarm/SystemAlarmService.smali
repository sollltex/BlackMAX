...
.method public final a()V
    ...
    :try_start_0
    sget-object v3, Lejf;->b:Ljava/util/WeakHashMap;
    ...
    sget-object v4, Ldjf;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v2}, Lu17;->U(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final onCreate()V
    ...
    invoke-direct {v0, p0}, Lyae;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmService;->b:Lyae;

    iget-object v1, v0, Lyae;->i:Lxae;
    ...
    invoke-virtual {v0, v1, v2}, Lu17;->n(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    iput-object p0, v0, Lyae;->i:Lxae;
...
.method public final onDestroy()V
    ...
    iget-object p0, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmService;->b:Lyae;
    ...
    iget-object v0, p0, Lyae;->d:Lb5b;

    invoke-virtual {v0, p0}, Lb5b;->e(Lk45;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lyae;->i:Lxae;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-virtual {p2, v0, v1}, Lu17;->w(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmService;->b:Lyae;
    ...
    iget-object v0, p2, Lyae;->d:Lb5b;

    invoke-virtual {v0, p2}, Lb5b;->e(Lk45;)V

    const/4 v0, 0x0

    iput-object v0, p2, Lyae;->i:Lxae;

    new-instance p2, Lyae;

    invoke-direct {p2, p0}, Lyae;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmService;->b:Lyae;

    iget-object v0, p2, Lyae;->i:Lxae;
    ...
    invoke-virtual {p2, v1, v0}, Lu17;->n(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    iput-object p0, p2, Lyae;->i:Lxae;
    ...
    invoke-virtual {p0, p3, p1}, Lyae;->a(ILandroid/content/Intent;)V
