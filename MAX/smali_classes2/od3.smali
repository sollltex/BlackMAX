...
.method public final uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    :cond_0
    sget-object p0, Lvh6;->c:Landroid/content/Context;
    ...
    :cond_1
    sget-object p1, Lvh6;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :catch_0
    invoke-static {p0}, Lvh6;->a(Ljava/io/File;)V
    ...
    invoke-static {v1, p1}, Lak5;->m0(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object p1

    const-string p2, "dump-meta.json"

    invoke-static {v1, p2}, Lak5;->m0(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1}, Lchd;->p(Ljava/io/File;)V
    ...
    invoke-static {p2}, Lchd;->p(Ljava/io/File;)V

    :cond_6
    invoke-static {p0, p1}, Lchd;->H(Ljava/io/File;Ljava/io/File;)V

    invoke-static {v0, p2}, Lchd;->H(Ljava/io/File;Ljava/io/File;)V
    :try_end_1
    ...
    :catch_1
    invoke-static {p1}, Lvh6;->a(Ljava/io/File;)V

    invoke-static {p2}, Lvh6;->a(Ljava/io/File;)V
