...
# direct methods
.method public constructor <init>(Lfyc;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lujd;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Ltyc;->e:Lfyc;

    iput-object p2, p0, Ltyc;->f:Ljava/util/concurrent/Executor;
...
.method public final H(Lpkd;I)V
    ...
    invoke-virtual {p1, p0}, Lsyc;->E(Le76;)V
...
.method public final t(Landroid/view/ViewGroup;I)La9c;
    ...
    iget-object p0, p0, Ltyc;->e:Lfyc;

    invoke-direct {p1, p0, p2, v0, v1}, Lsyc;-><init>(Lfyc;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V
