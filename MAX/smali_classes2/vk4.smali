...
.method public final a(JLjava/lang/Long;Ljava/lang/Long;)V
    ...
    invoke-virtual {p4, v4, v5}, Lu82;->z(J)Lj52;
    ...
    invoke-virtual {p3, v4, v5}, Lu82;->F(J)Lj52;
    ...
    :cond_2
    iget-object p4, p3, Lj52;->b:Lp92;

    iget-object p4, p4, Lp92;->f0:Lj7a;

    if-nez p4, :cond_3

    const-string p0, "draft is null, ignore"

    invoke-static {v1, p0, v0}, Lo2g;->F(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_3
    invoke-virtual {p4}, Lj7a;->b()Ljava/lang/Long;
    ...
    iget-wide p1, p3, Lj52;->a:J

    invoke-virtual {p0, p1, p2}, Lu82;->p(J)V
