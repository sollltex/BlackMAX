...
# direct methods
.method public constructor <init>(Lfdc;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lujd;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Llad;->e:Lfdc;
...
.method public final H(Lpkd;I)V
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lkad;->B(Lzj7;)V
    ...
    iget-object v0, v0, Lovc;->g:Lone/me/sdk/sections/SettingsItem$EndViewType;

    instance-of v0, v0, Lone/me/sdk/sections/SettingsItem$EndViewType$Switch;

    iget-object p0, p0, Llad;->e:Lfdc;
    ...
    invoke-direct {v0, v1, p0}, Lll;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1, v0}, Lu9d;->setOnSwitchCheckedListener(Lg56;)V
    ...
    invoke-virtual {p1, v0}, Lu9d;->setOnSwitchListener(Lq9d;)V
...
.method public final bridge synthetic r(La9c;I)V
    ...
    invoke-virtual {p0, p1, p2}, Llad;->H(Lpkd;I)V
