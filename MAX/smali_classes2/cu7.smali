...
.method public final c()V
    ...
    iput-object v0, p0, Lcu7;->j:Ljava/lang/String;
...
.method public final f(IILjava/lang/String;)Z
    ...
    :cond_0
    iget-object v1, p0, Lcu7;->j:Ljava/lang/String;

    if-eqz v1, :cond_1

    invoke-static {v1, p3}, Lnwe;->c(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_1
    iput-boolean v0, p0, Lcu7;->k:Z

    iput-object p3, p0, Lcu7;->j:Ljava/lang/String;
...
.method public final onLoaded(Lone/me/rlottie/RLottieDrawable;)V
    ...
    invoke-static {p0, v0, p1}, Lo2g;->s(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final onNextFrameRendered(Lone/me/rlottie/RLottieDrawable;I)V
    ...
    iget-boolean p1, p0, Lcu7;->k:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcu7;->l:Lbu7;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lbu7;->e()V

    :cond_0
    const/4 p1, 0x0

    iput-boolean p1, p0, Lcu7;->k:Z

    :cond_1
    return-void
.end method

.method public final setFailureListener(Lau7;)V
    .locals 0

    iput-object p1, p0, Lcu7;->m:Lau7;

    return-void
.end method

.method public final setOnFirstFrameListener(Lbu7;)V
    .locals 0

    iput-object p1, p0, Lcu7;->l:Lbu7;
