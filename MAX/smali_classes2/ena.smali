...
# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;ZLryb;)V
    .locals 2
    ...
    iput-object v0, p0, Lena;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lena;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iput-object v0, p0, Lena;->a:Lorg/webrtc/HardwareVideoEncoderFactory;

    if-eqz p2, :cond_0

    new-instance p1, Lgna;

    invoke-direct {p1, p0, p3}, Lgna;-><init>(Lena;Lryb;)V
    ...
    :goto_0
    iput-object p1, p0, Lena;->c:Lgna;

    iput-object p3, p0, Lena;->d:Lryb;
...
.method public final createEncoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoEncoder;
    ...
    :goto_0
    iget-object v1, p0, Lena;->a:Lorg/webrtc/HardwareVideoEncoderFactory;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lena;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;
    ...
    iget-object v3, p0, Lena;->d:Lryb;

    const-string v4, "PatchedVideoEncoderFactory"

    invoke-interface {v3, v4, v2}, Lryb;->log(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, Lena;->e:Lorg/webrtc/VideoCodecInfo;

    iget-object p0, p0, Lena;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    invoke-direct {v2, p1, v3}, Lyna;-><init>(Lfoa;I)V

    new-instance v3, Lz4g;

    const/4 v4, 0x1

    invoke-direct {v3, p1, v2, v4}, Lz4g;-><init>(Lfoa;Loj3;I)V

    const-string v2, "onNewCodecIsCreating"

    invoke-virtual {p1, v2, v3}, Lfoa;->i(Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object p0, p0, Lena;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;
...
.method public final q(Lo18;)V
    ...
    invoke-virtual {p0, p1}, Lgna;->q(Lo18;)V
