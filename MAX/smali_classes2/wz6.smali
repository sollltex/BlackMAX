...
.field public final h:Lvz6;

.field public final i:Lvz6;
...
.method public constructor <init>(FFI)V
    ...
    iput-object p1, p0, Lwz6;->d:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lwz6;->e:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lwz6;->f:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lwz6;->g:Landroid/graphics/Path;

    new-instance p1, Lvz6;

    invoke-direct {p1, p0}, Lvz6;-><init>(Lwz6;)V

    iput-object p1, p0, Lwz6;->h:Lvz6;
    ...
    invoke-direct {p2, p1, p0}, Lvz6;-><init>(Ljava/lang/Integer;Lwz6;)V

    iput-object p2, p0, Lwz6;->i:Lvz6;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    :try_start_0
    iget-object v1, p0, Lwz6;->f:Landroid/graphics/Path;

    iget-object v2, p0, Lwz6;->d:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v2}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    sget-object v1, Lwz6;->j:[Lza7;

    const/4 v2, 0x0

    aget-object v1, v1, v2

    iget-object v1, p0, Lwz6;->h:Lvz6;
    ...
    iget-object p0, p0, Lwz6;->g:Landroid/graphics/Path;
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lwz6;->f:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lwz6;->e:Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lwz6;->g:Landroid/graphics/Path;
    ...
    sget-object v0, Lwz6;->j:[Lza7;

    aget-object v0, v0, v5

    iget-object p0, p0, Lwz6;->h:Lvz6;
...
.method public final setAlpha(I)V
    ...
    iget-object p0, p0, Lwz6;->d:Landroid/graphics/Paint;
