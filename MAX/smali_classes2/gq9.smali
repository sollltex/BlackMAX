...
.field public final b:Ljaa;

.field public final c:Lw84;

.field public final d:Lz6a;

.field public final e:Lv2b;

.field public f:Landroid/app/NotificationManager;


# direct methods
.method public constructor <init>(Landroid/content/Context;Ljaa;Lw84;Lz6a;Lv2b;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lgq9;->a:Landroid/content/Context;

    iput-object p2, p0, Lgq9;->b:Ljaa;

    iput-object p3, p0, Lgq9;->c:Lw84;

    iput-object p4, p0, Lgq9;->d:Lz6a;

    iput-object p5, p0, Lgq9;->e:Lv2b;
...
# virtual methods
.method public final a()Lfq9;
    .locals 12

    iget-object v0, p0, Lgq9;->c:Lw84;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget v0, Lvwb;->tt_notif_category_active_calls:I

    iget-object p0, p0, Lgq9;->a:Landroid/content/Context;
    ...
    invoke-direct/range {v1 .. v11}, Lfq9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    return-object p0
.end method

.method public final b()Lfq9;
    .locals 14

    iget-object v0, p0, Lgq9;->e:Lv2b;
    ...
    invoke-virtual {v1, v2}, Llq;->x(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lgq9;->h(Z)Landroid/net/Uri;
    ...
    sget v1, Lvwb;->tt_notif_category_chats:I
    ...
    iget-object p0, v0, Ly2b;->c:Llq;

    iget-object p0, p0, Le4;->f:Lce7;

    const-string v1, "app.notification.chats.vibrate"

    invoke-virtual {p0, v1, v2}, Lce7;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-direct/range {v3 .. v13}, Lfq9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    return-object p0
.end method

.method public final c()Lfq9;
    .locals 14
    ...
    invoke-virtual {p0, v2}, Lgq9;->h(Z)Landroid/net/Uri;
    ...
    sget v1, Lvwb;->tt_notif_category_dialogs:I
...
.method public final d()Lfq9;
    .locals 13

    iget-object v0, p0, Lgq9;->b:Ljaa;
    ...
    sget v0, Lvwb;->tt_notif_category_inapp:I

    iget-object v1, p0, Lgq9;->a:Landroid/content/Context;

    invoke-virtual {v1, v0}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    iget-object p0, p0, Lgq9;->e:Lv2b;
    ...
    invoke-direct/range {v2 .. v12}, Lfq9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V
...
.method public final e(Lfq9;)V
    ...
    iget-object v1, p1, Lfq9;->a:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lfq9;->c:Z

    const/4 v2, 0x4

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Lfq9;->f:Z
    ...
    iget-object v5, p1, Lfq9;->b:Ljava/lang/String;

    invoke-direct {v3, v1, v5, v0}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V

    iget-object v0, p1, Lfq9;->e:Landroid/net/Uri;

    if-eqz v0, :cond_5

    iget-object v5, p0, Lgq9;->c:Lw84;
    ...
    invoke-virtual {v0}, Ljaa;->d()I

    move-result v0

    invoke-virtual {v3, v0}, Landroid/app/NotificationChannel;->setLightColor(I)V

    iget-object v0, p0, Lgq9;->d:Lz6a;

    invoke-virtual {v0, v1}, Lz6a;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final f()V
    ...
    iget-object v1, v0, Lgq9;->d:Lz6a;

    iget-object v2, v1, Lz6a;->e:Ltae;
    ...
    invoke-virtual {v3, v4}, Lzt;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v2}, Lzt;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, v4, v2}, Lz6a;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v2}, Lz6a;->a(ILjava/lang/String;)V

    :cond_3
    invoke-virtual/range {p0 .. p0}, Lgq9;->i()Landroid/app/NotificationManager;
    ...
    invoke-virtual/range {p0 .. p0}, Lgq9;->b()Lfq9;

    move-result-object v3

    invoke-virtual {v0, v3}, Lgq9;->e(Lfq9;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lgq9;->c()Lfq9;
    ...
    iget-object v6, v0, Lgq9;->e:Lv2b;

    iget-object v7, v0, Lgq9;->a:Landroid/content/Context;
    ...
    iget-object v8, v3, Ly2b;->c:Llq;

    const-string v9, "app.notification.ringtone"

    invoke-virtual {v8, v9}, Llq;->x(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v5}, Lgq9;->h(Z)Landroid/net/Uri;

    move-result-object v14

    sget v8, Lvwb;->tt_notif_category_misc:I
    ...
    invoke-virtual {v3, v4, v5}, Le4;->d(Ljava/lang/String;Z)Z
    ...
    invoke-direct/range {v9 .. v19}, Lfq9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V
    ...
    invoke-virtual/range {p0 .. p0}, Lgq9;->d()Lfq9;
    ...
    sget v3, Lvwb;->tt_notif_category_file_loading:I
    ...
    invoke-direct/range {v8 .. v18}, Lfq9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V
    ...
    sget v3, Lvwb;->tt_notif_category_media:I
    ...
    sget v3, Lvwb;->tt_notif_category_incoming_calls:I
    ...
    invoke-virtual/range {p0 .. p0}, Lgq9;->a()Lfq9;
    ...
    sget v3, Lvwb;->tt_notif_category_live_location:I
...
.method public final h(Z)Landroid/net/Uri;
    ...
    iget-object p1, v0, Ly2b;->c:Llq;

    const-string v0, "app.notification.ringtone"

    invoke-virtual {p1, v0}, Llq;->x(Ljava/lang/String;)Ljava/lang/String;
...
.method public final i()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Lgq9;->f:Landroid/app/NotificationManager;

    if-nez v0, :cond_0

    iget-object v0, p0, Lgq9;->a:Landroid/content/Context;
    ...
    iput-object v0, p0, Lgq9;->f:Landroid/app/NotificationManager;

    :cond_0
    iget-object p0, p0, Lgq9;->f:Landroid/app/NotificationManager;
