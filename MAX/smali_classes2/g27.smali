...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lg27;->a:Ljava/lang/String;
...
.method public static c(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0}, Lmzf;-><init>(Landroid/content/Context;)V

    iget-object p0, v0, Lmzf;->b:Ljava/lang/Object;

    check-cast p0, Landroid/content/Intent;

    invoke-virtual {p0, p2}, Landroid/content/Intent;->setType(Ljava/lang/String;)Landroid/content/Intent;

    invoke-virtual {v0, p1}, Lmzf;->N(Landroid/net/Uri;)V

    invoke-virtual {v0}, Lmzf;->P()V
...
.method public static d(Landroid/content/Context;Ljava/lang/CharSequence;Landroid/net/Uri;)V
    ...
    invoke-virtual {v0, p1}, Lmzf;->O(Ljava/lang/CharSequence;)V

    invoke-virtual {v0, p2}, Lmzf;->N(Landroid/net/Uri;)V

    invoke-virtual {v0}, Lmzf;->A()Landroid/content/Intent;

    move-result-object p1

    invoke-static {p0, p1}, Lg27;->a(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/Intent;
