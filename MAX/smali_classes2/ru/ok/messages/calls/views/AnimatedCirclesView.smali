...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget p2, Ldob;->calls_circle_1:I

    invoke-static {p2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p2

    sget v0, Ldob;->calls_circle_3:I

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    sget v1, Ldob;->calls_circle_4:I

    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    sget v2, Ldob;->calls_circle_2:I
    ...
    invoke-direct {v2, p1}, Lxf;-><init>(Landroid/content/Context;)V
    ...
    iget-object v3, v2, Lxf;->a:Landroid/graphics/Paint;

    invoke-virtual {v2}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-static {v4, v1}, Ljt3;->a(Landroid/content/Context;I)I
