...
.method private write(ZLru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;Ljava/io/OutputStream;)V
    ...
    invoke-direct {p1, p3}, Lrja;-><init>(Ljava/io/OutputStream;)V

    invoke-direct {p0, p1}, Lcya;-><init>(Ljava/io/Writer;)V
    ...
    invoke-virtual {p1, p0, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->serialize(Lha7;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
