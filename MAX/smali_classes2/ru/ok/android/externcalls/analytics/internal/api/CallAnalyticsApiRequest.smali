...
.field private final items:Les0;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILes0;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;)V
    .locals 0
    ...
    iput-object p7, p0, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->items:Les0;
...
.method public static synthetic a(Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;Lw97;)Ljava/lang/Void;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->lambda$getOkParser$0(Lw97;)Ljava/lang/Void;
...
.method private synthetic lambda$getOkParser$0(Lw97;)Ljava/lang/Void;
    .locals 2
...
.method private writeString(Lha7;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lha7;Ljava/lang/String;Ljava/lang/String;Z)V

    return-void
.end method

.method private writeString(Lha7;Ljava/lang/String;Ljava/lang/String;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 3
    :cond_0
    invoke-interface {p1, p2}, Lha7;->h0(Ljava/lang/String;)Lha7;

    .line 4
    invoke-interface {p1, p3}, Lha7;->i(Ljava/lang/String;)V
...
.method public canRepeat()Z
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->items:Les0;
...
.method public writeParams(Lha7;)V
    ...
    invoke-direct {p0, p1, v2, v0, v1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lha7;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lha7;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lu2;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Les0;->write(Lha7;)V
...
.method public bridge synthetic writeSupplyParams(Lha7;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
