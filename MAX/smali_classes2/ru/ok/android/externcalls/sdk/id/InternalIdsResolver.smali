...
.method private applyInternalIds(Ljava/util/Map;)V
    ...
    invoke-interface {v0, v2, v1}, Lru/ok/android/externcalls/sdk/id/InternalIdsResolver$ParticipantPrivateStateModifier;->setInternalId(Lru/ok/android/externcalls/sdk/ConversationParticipant;Llg1;)V
...
.method private getResolutionCandidates()Ljava/util/List;
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationParticipantExtensionsKt;->getInternalIdExt(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Llg1;
...
# virtual methods
.method public resolveIdsAndGetFailed()Lrkd;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
