...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;",
        "peerId",
        "Lru/ok/android/externcalls/sdk/api/JoinByIdResponse;",
        "joinToConversation",
        "(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;",
        "anonToken",
        "Lru/ok/android/externcalls/sdk/api/ConversationParams;",
        "getConversationParams",
        "(Ljava/lang/String;Ljava/lang/String;)Lrkd;",
        "initialJoinLink",
        "getJoinConversationParamsExt",
        "(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;",
        "opponents",
        "startConversation",
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;",
        "opponentIds",
        "startConversationWithExternalIds",
        "createJoinLink",
        "(Ljava/lang/String;)Lrkd;",
        "Lbl0;",
        "joinReq",
        "Lqxe;",
...
# instance fields
.field private final rxApiClient:Lmkc;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/OkApiService$Companion;-><init>(Lg94;)V
...
.method public constructor <init>(Lmkc;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Lmkc;

    return-void
.end method

.method public static synthetic getConversationParams$default(Lru/ok/android/externcalls/sdk/api/OkApiService;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Lrkd;
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lru/ok/android/externcalls/sdk/api/OkApiService;->getConversationParams(Ljava/lang/String;Ljava/lang/String;)Lrkd;
...
.method private final startConversationImpl(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;
    .locals 4
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Lmkc;

    const-string v1, "vchat.startConversation"

    invoke-static {v1}, Ldw7;->G(Ljava/lang/String;)Lbl0;

    move-result-object v1

    sget-object v2, Lum;->c:Lum;

    iput-object v2, v1, Lbl0;->b:Lum;
    ...
    invoke-virtual {v1, v3, v2}, Lbl0;->c(Ljava/lang/String;Z)V

    const-string v2, "turnServers"

    invoke-virtual {v1, v2, p1}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "conversationId"

    invoke-virtual {v1, p1, p2}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v2, p2, p3}, Le27;-><init>(Ljava/lang/String;J)V

    iget-object p2, v1, Lbl0;->c:Lom;

    invoke-virtual {p2, p1}, Lom;->a(Lnm;)V
    ...
    invoke-virtual {v1, p2, p1}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p4, p5, p7, v1}, Lru/ok/android/externcalls/sdk/api/OkApiService;->addCreateConversationParams(Lru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lbl0;)V

    :cond_3
    if-eqz p6, :cond_4

    invoke-virtual {p0, p4, p6, p7, v1}, Lru/ok/android/externcalls/sdk/api/OkApiService;->addCreateConversationParamsByExternalOpponentIds(Lru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lbl0;)V
    ...
    invoke-virtual {v1, p1, p0}, Lbl0;->c(Ljava/lang/String;Z)V

    sget-object p0, Lru/ok/android/externcalls/sdk/api/CallInfo;->PARSER:Lr97;

    invoke-virtual {v1, p0}, Lbl0;->a(Lr97;)Lcl0;

    move-result-object p0

    invoke-virtual {v0, p0}, Lmkc;->a(Lim;)Lmld;
...
.method public addCreateConversationParams(Lru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lbl0;)V
    ...
    invoke-virtual {p4, p1, p0}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final createJoinLink(Ljava/lang/String;)Lrkd;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Lmkc;
    ...
    invoke-virtual {v0, v1, p1}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v2, v1}, Lru/ok/android/externcalls/sdk/api/UnwrappingParser;-><init>(Ljava/lang/String;Lr97;)V

    invoke-virtual {v0, p1}, Lbl0;->a(Lr97;)Lcl0;

    move-result-object p1

    invoke-virtual {p0, p1}, Lmkc;->a(Lim;)Lmld;
...
.method public final getConversationParams(Ljava/lang/String;Ljava/lang/String;)Lrkd;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, p2}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V

    :cond_1
    sget-object p1, Lru/ok/android/externcalls/sdk/api/ConversationParams;->PARSER:Lr97;
...
.method public final getJoinConversationParamsExt(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1, p1}, Lbl0;->c(Ljava/lang/String;Z)V

    new-instance p1, Le27;

    const-string v1, "peerId"

    invoke-direct {p1, v1, p3, p4}, Le27;-><init>(Ljava/lang/String;J)V

    iget-object p3, v0, Lbl0;->c:Lom;

    invoke-virtual {p3, p1}, Lom;->a(Lnm;)V
    ...
    invoke-direct {p2, p4, p1}, Li3e;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p3, p2}, Lom;->a(Lnm;)V
    ...
    invoke-direct {p1, p2, p4, p5}, Le27;-><init>(Ljava/lang/String;J)V
    ...
    sget-object p1, Lru/ok/android/externcalls/sdk/api/JoinByLinkResponse;->PARSER:Lr97;
...
.method public final joinToConversation(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p1, v1, p2, p3}, Le27;-><init>(Ljava/lang/String;J)V

    iget-object p2, v0, Lbl0;->c:Lom;
    ...
    invoke-virtual {v0, p3, p1}, Lbl0;->c(Ljava/lang/String;Z)V
    ...
    invoke-direct {p1, p3, v1, v2}, Le27;-><init>(Ljava/lang/String;J)V
    ...
    :cond_1
    invoke-virtual {p0, p4, v0}, Lru/ok/android/externcalls/sdk/api/OkApiService;->addJoinToConversationParams(Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lbl0;)V

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Lmkc;

    sget-object p1, Lnwe;->b:Lhn9;
...
.method public final startConversation(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v7}, Lru/ok/android/externcalls/sdk/api/OkApiService;->startConversationImpl(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;
...
.method public final startConversationWithExternalIds(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lrkd;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
