...
.method private parseIds(Ljava/util/Map;Lw97;Z)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2}, Lw97;->t()V

    :goto_0
    invoke-interface {p2}, Lw97;->hasNext()Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-interface {p2}, Lw97;->U()Ljava/lang/String;

    move-result-object p0

    invoke-interface {p2}, Lw97;->K()Ljava/lang/String;

    move-result-object v0

    :try_start_0
    invoke-static {p0}, Llg1;->a(Ljava/lang/String;)Llg1;
...
# virtual methods
.method public bridge synthetic parse(Lw97;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 1
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse$1;->parse(Lw97;)Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse;
...
.method public parse(Lw97;)Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 7
    invoke-direct {p0, v0, p1, v1}, Lru/ok/android/externcalls/sdk/api/ExternalIdsResponse$1;->parseIds(Ljava/util/Map;Lw97;Z)V
