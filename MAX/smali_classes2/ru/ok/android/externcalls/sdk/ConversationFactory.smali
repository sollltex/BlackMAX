...
.field private animojiDataSupplier:Llj;
...
.field private badNetworkIndicatorConfig:Lig0;

.field private bitrates:Lhg1;
...
.field private final experiments:Lig1;
...
.field private groupCallMediaAdaptationConfig:Lr18;
...
.field private log:Lryb;

.field private logConfiguration:Lsyb;
...
.field private p2pCallMediaAdaptationConfig:Lr18;
...
.field private final tracerLiteFacade:Lmre;
...
.method public constructor <init>(Lkz9;Landroid/content/Context;Ljava/lang/String;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lru/ok/android/externcalls/sdk/ConversationFactory;-><init>(Lkz9;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public constructor <init>(Lkz9;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    .locals 7
    ...
    invoke-direct {v6, v0, v1}, Lzv3;-><init>(Ljava/time/Clock;I)V
    ...
    .line 3
    invoke-direct/range {v1 .. v6}, Lru/ok/android/externcalls/sdk/ConversationFactory;-><init>(Lkz9;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lru/ok/android/externcalls/sdk/log/ExtLogger$TimeProvider;)V

    return-void
.end method

.method public constructor <init>(Lkz9;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lru/ok/android/externcalls/sdk/log/ExtLogger$TimeProvider;)V
    .locals 5
    ...
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lryb;

    .line 9
    sget-object v2, Lru/ok/android/externcalls/sdk/CallUtil;->LOG_CONFIGURATION:Lsyb;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Lsyb;
    ...
    .line 22
    sget-object v2, Laic;->t0:Lap3;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Laic;
    ...
    invoke-direct {v3}, Lig1;-><init>()V

    iput-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lig1;

    .line 34
    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->locale:Ljava/util/Locale;

    .line 35
    sget-object v2, Lf36;->b:Lf36;

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Llj;
    ...
    .line 41
    sget-object v0, Lig0;->e:Lig0;

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->badNetworkIndicatorConfig:Lig0;
    ...
    .line 48
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lkz9;
    ...
    .line 52
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Ldc3;

    .line 53
    new-instance p3, Lru/ok/android/externcalls/sdk/factory/internal/RTCLogWrapper;

    new-instance p4, Lyv3;

    const/4 v2, 0x0

    invoke-direct {p4, p0, v2}, Lyv3;-><init>(Lru/ok/android/externcalls/sdk/ConversationFactory;I)V

    invoke-direct {p3, p4}, Lru/ok/android/externcalls/sdk/factory/internal/RTCLogWrapper;-><init>(Lq46;)V

    invoke-static {p2, p3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->get(Landroid/content/Context;Lryb;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    ...
    invoke-direct {v3, v2, v4}, Lzv3;-><init>(Ljava/time/Clock;I)V
    ...
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Lhg1;

    .line 60
    new-instance p3, Lru/ok/android/externcalls/sdk/api/OkApiService;

    invoke-virtual {p1}, Lkz9;->c()Lmkc;

    move-result-object p4

    invoke-direct {p3, p4}, Lru/ok/android/externcalls/sdk/api/OkApiService;-><init>(Lmkc;)V
    ...
    invoke-direct {p3, p2}, Lmre;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Lmre;
    ...
    invoke-direct {p4, p0, p5}, Lyv3;-><init>(Lru/ok/android/externcalls/sdk/ConversationFactory;I)V

    invoke-virtual {p2, v0, p3, p1, p4}, Lru/ok/android/externcalls/sdk/analytics/CallAnalyticsInitializer;->init(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lru/ok/android/externcalls/sdk/analytics/ConversationAnalyticsConfigurationImpl;Lkz9;Lq46;)V

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/ConversationFactory;)Lryb;
    .locals 0

    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$new$0()Lryb;
...
.method public static synthetic b(Lw97;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$hangup$21(Lw97;)Ljava/lang/Object;
...
.method private getBaseBuilder()Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lkz9;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lkz9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lryb;

    instance-of v2, v1, Lure;
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Lmre;

    invoke-direct {v2, v3, v1}, Lure;-><init>(Lmre;Lryb;)V

    move-object v1, v2

    :goto_0
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setLog(Lryb;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Lsyb;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setLogConfiguration(Lsyb;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Lhg1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBitrates(Lhg1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Laic;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setRotationProvider(Laic;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Llj;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setAnimojiDataSupplier(Llj;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->p2pCallMediaAdaptationConfig:Lr18;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setP2PCallMediaAdaptationConfig(Lr18;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->groupCallMediaAdaptationConfig:Lr18;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setGroupCallMediaAdaptationConfig(Lr18;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lig1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setExperiments(Lig1;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->badNetworkIndicatorConfig:Lig0;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setBadNetworkIndicatorConfig(Lig0;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->screenCapturePermissionProvider:Lspc;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setScreenCapturePermissionProvider(Lspc;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
...
.method public static declared-synchronized init(Lru/ok/android/externcalls/sdk/ConversationFactoryInitParams;)V
    ...
    .line 16
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationFactoryInitParams$PeerConnection;->getLogger()Lryb;
    ...
    invoke-direct/range {v15 .. v23}, Lhoa;-><init>(ZLjava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    .line 40
    invoke-direct/range {v19 .. v27}, Lhoa;-><init>(ZLjava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    .line 42
    invoke-direct/range {v5 .. v18}, Lioa;-><init>(ZZLjava/lang/String;Ljava/lang/String;Ljava/lang/Integer;ZZZZLhoa;ZZLjava/lang/String;)V
    ...
    .line 44
    invoke-direct {v2, v0, v4, v6, v5}, Lfhc;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
    ...
    .line 46
    invoke-static {v3, v2, v0}, Lfoa;->D(Landroid/content/Context;Lfhc;Lorg/webrtc/NativeLibraryLoader;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static synthetic l(Lru/ok/android/externcalls/sdk/ConversationFactory;)Lryb;
    .locals 0

    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$new$1()Lryb;
...
.method private static synthetic lambda$answer$6(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;Lru/ok/android/externcalls/sdk/Conversation;)V
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getOnPrepared()Ls46;
...
.method private static synthetic lambda$answer$7(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getOnError()Ls46;
...
.method private static synthetic lambda$hangup$21(Lw97;)Ljava/lang/Object;
    .locals 0
...
.method private synthetic lambda$new$0()Lryb;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lryb;

    return-object p0
.end method

.method private synthetic lambda$new$1()Lryb;
    .locals 0
...
# virtual methods
.method public answer(Ls46;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getCameraCapturerFactory()Lzu9;

    move-result-object v3

    invoke-virtual {v1, v3}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lzu9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;

    move-result-object v1

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/BaseCallParams;->getFrameInterceptor()Lf02;

    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(Lf02;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenProvider()Lape;

    move-result-object v3

    if-eqz v3, :cond_0

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lkz9;

    invoke-virtual {v3}, Lkz9;->d()Lyy2;

    move-result-object v3

    iget-object v4, v3, Lyy2;->a:Ljava/lang/Object;

    check-cast v4, Lpe3;

    new-instance v5, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v5, v4}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lpe3;)V

    iput-object v5, v3, Lyy2;->a:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenProvider()Lape;

    move-result-object v4

    iput-object v4, v3, Lyy2;->b:Ljava/lang/Object;

    invoke-virtual {v3}, Lyy2;->f()Lkz9;

    move-result-object v3

    invoke-virtual {v1, v3}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lkz9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object v4, v3, Lyy2;->g:Ljava/lang/Object;
    ...
    iput-object v4, v3, Lyy2;->g:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;->getTokenInfoProvider()Lbn;

    move-result-object v4

    iput-object v4, v3, Lyy2;->f:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lryb;

    const-string v4, "Try to decode provided conversation params"

    invoke-interface {v3, v0, v4}, Lryb;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p0, v0, v3}, Lryb;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Lxv3;-><init>(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;I)V

    new-instance v0, Lxv3;

    const/4 v3, 0x1

    invoke-direct {v0, p1, v3}, Lxv3;-><init>(Lru/ok/android/externcalls/sdk/factory/AnswerCallParams;I)V

    invoke-virtual {v1, v2, p0, v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;Loj3;Loj3;)V

    return-object v1
.end method

.method public call(Ls46;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(Lf02;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {v0, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lzu9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenProvider()Lape;

    move-result-object v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lkz9;

    invoke-virtual {v2}, Lkz9;->d()Lyy2;

    move-result-object v2

    iget-object v3, v2, Lyy2;->a:Ljava/lang/Object;

    check-cast v3, Lpe3;

    new-instance v4, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;

    invoke-direct {v4, v3}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lpe3;)V

    iput-object v4, v2, Lyy2;->a:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenProvider()Lape;

    move-result-object v3

    iput-object v3, v2, Lyy2;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Lyy2;->f()Lkz9;

    move-result-object v2

    invoke-virtual {v0, v2}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lkz9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lkz9;

    invoke-virtual {p0}, Lkz9;->d()Lyy2;
    ...
    invoke-static {v2}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$call$2(Lxm;)Lxm;

    move-result-object v2

    iput-object v2, p0, Lyy2;->g:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/StartCallParams;->getTokenInfoProvider()Lbn;

    move-result-object v2

    iput-object v2, p0, Lyy2;->f:Ljava/lang/Object;

    invoke-virtual {p0}, Lyy2;->f()Lkz9;

    move-result-object p0

    invoke-virtual {v0, p0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lkz9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-direct {v0, p1, v2}, Lsv3;-><init>(Lru/ok/android/externcalls/sdk/factory/StartCallParams;I)V

    new-instance v2, Lsv3;

    const/4 v3, 0x1

    invoke-direct {v2, p1, v3}, Lsv3;-><init>(Lru/ok/android/externcalls/sdk/factory/StartCallParams;I)V

    invoke-virtual {p0, v1, v0, v2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;Loj3;Loj3;)V
...
.method public clearApiAuthSession()V
    ...
    invoke-virtual {p0}, Lkz9;->b()Llz9;

    move-result-object p0

    invoke-interface {p0}, Llz9;->a()V

    return-void
.end method

.method public createConfRoom(Ls46;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lzu9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/CreateConfParams;->getTokenProvider()Lape;
    ...
    invoke-direct {v3, v2}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lpe3;)V

    iput-object v3, v1, Lyy2;->a:Ljava/lang/Object;

    invoke-virtual {v1}, Lyy2;->f()Lkz9;
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationFactory;->lambda$createConfRoom$18(Lxm;)Lxm;

    move-result-object v1

    iput-object v1, p0, Lyy2;->g:Ljava/lang/Object;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/CreateConfParams;->getTokenInfoProvider()Lbn;

    move-result-object v1

    iput-object v1, p0, Lyy2;->f:Ljava/lang/Object;
    ...
    invoke-direct {v5, p1, v0}, Law3;-><init>(Lru/ok/android/externcalls/sdk/factory/CreateConfParams;I)V

    new-instance v6, Law3;

    const/4 v0, 0x1

    invoke-direct {v6, p1, v0}, Law3;-><init>(Lru/ok/android/externcalls/sdk/factory/CreateConfParams;I)V
    ...
    invoke-virtual/range {v1 .. v6}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;ZZLoj3;Loj3;)V
...
.method public getAnimojiDataSupplier()Llj;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Llj;
...
.method public hangup(Lug6;Ljava/lang/String;)V
    .locals 1

    const/4 v0, 0x0

    .line 19
    invoke-virtual {p0, p1, p2, v0}, Lru/ok/android/externcalls/sdk/ConversationFactory;->hangup(Lug6;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public hangup(Lug6;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    ...
    .line 5
    invoke-virtual {v0, v1, p2}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2, p1}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "anonymToken"

    .line 7
    invoke-virtual {v0, p1, p3}, Lbl0;->b(Ljava/lang/String;Ljava/lang/String;)V

    .line 8
    sget-object p1, Lnp8;->d:Lnx7;

    invoke-virtual {v0, p1}, Lbl0;->a(Lr97;)Lcl0;

    move-result-object p1

    .line 9
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lkz9;

    .line 10
    invoke-virtual {p2}, Lkz9;->c()Lmkc;
    ...
    invoke-direct {p3, v0}, Ljq0;-><init>(I)V
    ...
    invoke-direct {v0, p1, p3}, Lffb;-><init>(Lpm;Lr97;)V

    .line 12
    invoke-virtual {p2, v0}, Lmkc;->a(Lim;)Lmld;

    move-result-object p1

    .line 13
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lig1;

    iget-boolean p2, p2, Lig1;->h:Z

    iget-object p3, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lryb;

    .line 14
    invoke-static {p1, p2, p3}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForBackgroundWork(Lrkd;ZLryb;)Lrkd;
    ...
    invoke-direct {p2, p3}, Ljq0;-><init>(I)V

    new-instance p3, Luv3;

    const/4 v0, 0x0

    invoke-direct {p3, v0}, Luv3;-><init>(I)V
    ...
    invoke-direct {v0, p2, v1, p3}, Lsq1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    .line 17
    invoke-virtual {p1, v0}, Lrkd;->j(Lnld;)V

    .line 18
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Ldc3;
...
.method public join(Ls46;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(Lf02;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lzu9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-direct {v1, p1, v2}, Lwv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinCallParams;I)V

    new-instance v2, Lwv3;

    const/4 v3, 0x1

    invoke-direct {v2, p1, v3}, Lwv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinCallParams;I)V

    invoke-virtual {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepare(Lru/ok/android/externcalls/sdk/api/ConversationParams;Loj3;Loj3;)V

    return-object p0
.end method

.method public joinAnonByLink(Ls46;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lkz9;

    invoke-virtual {v0}, Lkz9;->d()Lyy2;

    move-result-object v0

    iget-object v1, v0, Lyy2;->f:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lyy2;->g:Ljava/lang/Object;
    ...
    invoke-direct {v1, v2, p1}, Lf12;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, v1}, Lru/ok/android/externcalls/sdk/SimpleConfigurationStore;-><init>(Lpe3;)V

    iput-object v2, v0, Lyy2;->a:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setFrameInterceptor(Lf02;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {v0}, Lyy2;->f()Lkz9;

    move-result-object v0

    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setApi(Lkz9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/ConversationBuilder;->setCameraCapturerFactory(Lzu9;)Lru/ok/android/externcalls/sdk/ConversationBuilder;
    ...
    invoke-direct {v0, p1, v1}, Ltv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;I)V

    new-instance v1, Ltv3;

    const/4 v2, 0x1

    invoke-direct {v1, p1, v2}, Ltv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;I)V

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/JoinAnonByLinkParams;->getToken()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, v0, v1, p1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepareJoinByLink(Loj3;Loj3;Ljava/lang/String;)V

    return-object p0
.end method

.method public joinByLink(Ls46;)Lru/ok/android/externcalls/sdk/Conversation;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;->getTokenProvider()Lape;
    ...
    invoke-direct {v0, p1, v2}, Lvv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;I)V

    new-instance v2, Lvv3;

    const/4 v3, 0x1

    invoke-direct {v2, p1, v3}, Lvv3;-><init>(Lru/ok/android/externcalls/sdk/factory/JoinByLinkParams;I)V

    invoke-virtual {p0, v0, v2, v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->prepareJoinByLink(Loj3;Loj3;Ljava/lang/String;)V
...
.method public reset()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->disposable:Ldc3;

    invoke-virtual {v0}, Ldc3;->d()V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->api:Lkz9;

    invoke-virtual {v0}, Lkz9;->b()Llz9;

    move-result-object v0

    invoke-interface {v0}, Llz9;->a()V
...
.method public setAnimojiDataSupplier(Llj;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->animojiDataSupplier:Llj;
...
.method public setApiRetriesEnabled(Z)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lig1;

    iput-boolean p1, p0, Lig1;->h:Z
...
.method public setBadNetworkIndicatorConfig(Lig0;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->badNetworkIndicatorConfig:Lig0;
...
.method public setBitrates(Lhg1;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->bitrates:Lhg1;
...
.method public setCameraFrameMaxDimension(I)V
    ...
    iput-object p1, p0, Lig1;->e:Ljava/lang/Integer;
...
.method public setEnqueuedCommandMergeEnabled(Z)V
    ...
    iput-boolean p1, p0, Lig1;->i:Z

    return-void
.end method

.method public setExceptionConsumer(Lpyb;)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public setGroupCallMediaAdaptationConfig(Lr18;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->groupCallMediaAdaptationConfig:Lr18;
...
.method public setLogConfiguration(Lsyb;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->logConfiguration:Lsyb;

    return-void
.end method

.method public setLogger(Lryb;)V
    .locals 2
    ...
    sget-object v1, Lrm;->a:Lqm;

    invoke-interface {v0, v1}, Llz9;->k(Lrm;)V
    ...
    invoke-direct {v1, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;-><init>(Lryb;)V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->tracerLiteFacade:Lmre;

    invoke-direct {v0, v1, p1}, Lure;-><init>(Lmre;Lryb;)V

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->log:Lryb;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/log/GlobalRTCLogger;->setLog(Lryb;)V
...
.method public setP2PCallMediaAdaptationConfig(Lr18;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->p2pCallMediaAdaptationConfig:Lr18;

    return-void
.end method

.method public setRotationProvider(Laic;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->rotationProvider:Laic;
...
.method public setScreenCapturePermissionProvider(Lspc;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->screenCapturePermissionProvider:Lspc;
...
.method public setStartCallByExternalIdEnabled(Z)V
    ...
    iput-boolean p1, p0, Lig1;->j:Z

    return-void
.end method

.method public setTimeouts(Ljg1;)V
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lig1;

    iput-object p1, p0, Lig1;->f:Ljg1;
...
.method public setVideoDegradationForSoftwareCodec(ZLjava/lang/Float;Ljava/lang/Float;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationFactory;->experiments:Lig1;

    iput-boolean p1, v0, Lig1;->b:Z
