...
.method private final processFeedbackForResolvedInternalIds(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Llg1;
    ...
    invoke-virtual {v4, v5}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Llg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-direct/range {v4 .. v11}, Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedbackSource;ILg94;)V
...
.method private final scheduleRemoving()V
    ...
    invoke-direct {v5, p0, v0, v1, v6}, Lq70;-><init>(Ljava/lang/Object;JI)V
...
.method private final unrollReceivedFeedback(Lk71;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p1, Lk71;->b:Ljava/util/List;
    ...
    iget-object v1, v0, Lj71;->b:Ljava/util/List;
    ...
    iget-object v5, v0, Lj71;->a:Ljava/lang/String;

    invoke-direct {v4, v3, v5}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;-><init>(Llg1;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {v2, p1}, Lh63;->i0(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V
...
.method public onFeedback(Lk71;)V
    .locals 5
    ...
    :cond_0
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->unrollReceivedFeedback(Lk71;)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Llg1;
    ...
    invoke-direct {v2, p0, p1, v0, v4}, Ln05;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lrs4;

    const/16 v4, 0x15

    invoke-direct {p1, p0, v4, v0}, Lrs4;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
