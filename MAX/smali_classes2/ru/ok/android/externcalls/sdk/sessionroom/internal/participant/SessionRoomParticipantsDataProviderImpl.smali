...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Llg1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;",
        ...
        "(Ljava/util/Collection;Lq46;Ls46;)V",
        "getRoomParticipants",
        "(Lh5d;Ls46;Ls46;)V",
...
.method public static synthetic a(Ls46;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$9(Ls46;)V
...
.method public static final synthetic access$getRoomParticipantIds(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lg5d;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lg5d;)Ljava/util/Collection;
...
.method public static final synthetic access$mapInternalIdsToSessionRoomParticipants(Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Lh5d;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdsToSessionRoomParticipants(Lh5d;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static synthetic b(Ls46;Ls46;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llg1;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$0(Ls46;Ls46;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llg1;)V

    return-void
.end method

.method public static synthetic c(Ls46;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveInternalIdByExternal$lambda$1(Ls46;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
...
.method public static synthetic d(Lq46;)V
    ...
    invoke-static {p0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds$lambda$8(Lq46;)V
...
.method private final getAllRoomParticipantIds()Ljava/util/Collection;
    ...
    iget-object v1, v1, Lb5d;->e:Ljava/util/List;
    ...
    :cond_1
    invoke-static {v0}, Ld63;->g0(Ljava/lang/Iterable;)Ljava/util/ArrayList;
...
.method private final getMainCallParticipantIds(Ls46;Ls46;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lh5d;)Ljava/util/Collection;
    ...
    invoke-static {v2, v0}, Ld63;->f0(Ljava/lang/Iterable;I)I
    ...
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants;-><init>(Lh5d;Ljava/util/Collection;)V
...
.method private final getRoomParticipantIds(Lg5d;)Ljava/util/Collection;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Lb5d;->e:Ljava/util/List;
...
.method private final mapConversationParticipantToSessionRoomParticipant(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lh5d;

    move-result-object p0

    invoke-direct {v0, v1, p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lh5d;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V

    return-object v0
.end method

.method private final mapInternalIdToSessionRoomParticipant(Llg1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p1}, Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lh5d;Lru/ok/android/externcalls/sdk/ConversationParticipant;)V
...
.method private final mapInternalIdsToSessionRoomParticipants(Lh5d;Ljava/util/Collection;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->mapInternalIdToSessionRoomParticipant(Llg1;)Lru/ok/android/externcalls/sdk/sessionroom/participant/SessionRoomParticipants$Participant;
    ...
    invoke-virtual {p2, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lh5d;)Ljava/util/Collection;
...
.method private static final resolveInternalIdByExternal$lambda$0(Ls46;Ls46;Lru/ok/android/externcalls/sdk/id/ParticipantId;Llg1;)V
    .locals 1
...
.method private static final resolveInternalIdByExternal$lambda$1(Ls46;Lru/ok/android/externcalls/sdk/id/ParticipantId;)V
    .locals 3
...
.method private final resolveParticipantIds(Ljava/util/Collection;Lq46;Ls46;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, p2}, Lli0;-><init>(ILq46;)V

    new-instance p2, Li5d;

    const/4 v1, 0x0

    invoke-direct {p2, v1, p3}, Li5d;-><init>(ILs46;)V
...
.method private static final resolveParticipantIds$lambda$8(Lq46;)V
    .locals 0
...
.method private static final resolveParticipantIds$lambda$9(Ls46;)V
    .locals 2
...
.method public getAllInRoomParticipants(Ls46;Ls46;)V
    ...
    invoke-direct {v2, v0, p0, p1}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getAllInRoomParticipants$1;-><init>(Ljava/util/Set;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Ls46;)V

    invoke-direct {p0, v1, v2, p2}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lq46;Ls46;)V
...
.method public final getInternalIdsByExternal(Ljava/util/Collection;)Ljava/util/Map;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Llg1;
...
.method public getParticipantRoomId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ls46;Ls46;)V
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lh5d;
...
.method public getRoomParticipants(Lh5d;Ls46;Ls46;)V
    ...
    invoke-direct {p0, p2, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getMainCallParticipantIds(Ls46;Ls46;)V
    ...
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->getRoomParticipantIds(Lg5d;)Ljava/util/Collection;
    ...
    invoke-direct {v1, p2, p1, p0, v0}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl$getRoomParticipants$1;-><init>(Ls46;Lh5d;Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;Ljava/util/Collection;)V

    invoke-direct {p0, v0, v1, p3}, Lru/ok/android/externcalls/sdk/sessionroom/internal/participant/SessionRoomParticipantsDataProviderImpl;->resolveParticipantIds(Ljava/util/Collection;Lq46;Ls46;)V
...
.method public final resolveInternalIdByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ls46;Ls46;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p2, p3, p1, v1}, Lhd4;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/io/Serializable;I)V

    new-instance p2, Lejc;

    const/16 v1, 0xb

    invoke-direct {p2, p3, v1, p1}, Lejc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {p0, p1, v0, p2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Loj3;Ljava/lang/Runnable;)V
