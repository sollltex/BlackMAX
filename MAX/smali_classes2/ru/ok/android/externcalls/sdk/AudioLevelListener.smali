...
.field private final noise:Llwf;
...
.method public constructor <init>(SLandroid/os/Handler;Ljava/lang/Runnable;)V
    ...
    iput-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Llwf;
...
.method public onSample(IIILoka;)V
    ...
    invoke-virtual {p4, p2}, Loka;->a(I)S
    ...
    :goto_1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Llwf;
    ...
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Llwf;
