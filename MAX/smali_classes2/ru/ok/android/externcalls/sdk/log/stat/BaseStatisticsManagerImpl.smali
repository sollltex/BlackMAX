...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "builder",
        "setStat",
        "(Lv0a;Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lv0a;",
        "",
        "",
        "custom",
        "setCustom",
        "(Lv0a;Ljava/util/Map;)V",
        "calls-sdk_release"
    }
    k = 0x1
    mv = {
...
.method public makeState(Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lru/ok/android/onelog/OneLogItem;
    ...
    invoke-virtual {p0, v0, p1}, Lru/ok/android/externcalls/sdk/log/stat/BaseStatisticsManagerImpl;->setStat(Lv0a;Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lv0a;

    move-result-object p0

    invoke-virtual {p0}, Lv0a;->a()Lru/ok/android/onelog/OneLogItem;
...
.method public setCustom(Lv0a;Ljava/util/Map;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setStat(Lv0a;Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lv0a;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0}, Lru/ok/android/externcalls/sdk/log/stat/BaseStatisticsManagerImpl;->setCustom(Lv0a;Ljava/util/Map;)V

    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;->getCollector()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p1, Lv0a;->a:Ljava/lang/String;
    ...
    iput-object v0, p1, Lv0a;->c:Ljava/lang/String;
    ...
    invoke-virtual {p1, v0, v1}, Lv0a;->d(J)V
