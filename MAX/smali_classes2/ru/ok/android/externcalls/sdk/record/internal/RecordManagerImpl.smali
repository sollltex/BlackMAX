...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "toRecordDescription",
        "(Lvh1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;",
        ...
        "current",
        "setMyRecordHistory",
        "(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lh5d;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V",
        "reportStarted",
        "()V",
        "whoStoppedRecordId",
        "reportStopped",
        ...
        "onError",
        "startRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lq46;Ls46;)V",
        "Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;",
        "stopRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lq46;Ls46;)V",
...
.field private final commandParamsCreator:Lv4c;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl$Companion;-><init>(Lg94;)V
...
.method public constructor <init>(Lryb;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lru/ok/android/externcalls/sdk/events/RecordEventListener;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Lryb;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lv4c;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lh5d;

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lxh1;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lxh1;)V

    return-void
.end method

.method private final applyRecordStarted(Lxh1;)V
    .locals 2

    iget-object v0, p1, Lxh1;->b:Lvh1;

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->toRecordDescription(Lvh1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    ...
    iget-object p1, p1, Lxh1;->a:Lh5d;

    invoke-direct {p0, v1, p1, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lh5d;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lh5d;
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Ls46;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Ls46;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lq46;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lq46;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic d(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lq46;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lq46;Lorg/json/JSONObject;)V
...
.method public static synthetic f(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Ls46;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Ls46;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final notifyListenersWhenActiveRoomChanged(Lh5d;Lh5d;)V
    .locals 1
...
.method private static final onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lxh1;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->applyRecordStarted(Lxh1;)V
...
.method private static final onRecordStarted$lambda$5(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Lryb;
...
.method private final setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lh5d;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    .locals 2
...
.method private static final startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lq46;Lorg/json/JSONObject;)V
    .locals 0

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnSuccess()Ls46;
...
.method private static final startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Ls46;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnError()Ls46;
...
.method private static final stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lq46;Lorg/json/JSONObject;)V
    .locals 1

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnSuccess()Ls46;
...
.method private static final stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Ls46;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnError()Ls46;
...
.method private final toRecordDescription(Lvh1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    .locals 9

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lvh1;->c:Llg1;
    ...
    iget-object v0, p1, Lvh1;->c:Llg1;

    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Llg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v2, p1, Lvh1;->b:Lk7c;

    iget-wide v3, p1, Lvh1;->d:J

    iget-wide v5, p1, Lvh1;->a:J

    iget-object v7, p1, Lvh1;->e:Ljava/lang/String;

    iget-object v8, p1, Lvh1;->f:Ljava/lang/String;

    move-object v0, p0

    invoke-direct/range {v0 .. v8}, Lru/ok/android/externcalls/sdk/record/RecordDescription;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lk7c;JJLjava/lang/String;Ljava/lang/String;)V
...
.method public final getRecordAdmin()Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lh5d;
...
.method public onCurrentParticipantActiveRoomChanged(Lxl1;)V
    ...
    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->notifyListenersWhenActiveRoomChanged(Lh5d;Lh5d;)V
...
.method public onRecordError(Lwh1;)V
    .locals 0

    iget-object p1, p1, Lwh1;->a:Ljava/lang/String;
...
.method public onRecordStarted(Lxh1;)V
    .locals 4

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lxh1;->b:Lvh1;

    iget-object v2, v1, Lvh1;->c:Llg1;

    invoke-virtual {v0, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Llg1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-direct {v2, p0, v3, p1}, Loea;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p1, Lwyb;

    const/4 v3, 0x2

    invoke-direct {p1, v3, p0}, Lwyb;-><init>(ILjava/lang/Object;)V
...
.method public onRecordStopped(Lyh1;)V
    .locals 3

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->sessionRoomToRecordInfo:Ljava/util/HashMap;

    iget-object v1, p1, Lyh1;->a:Lh5d;
    ...
    :goto_0
    invoke-direct {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lh5d;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
...
.method public startRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lq46;Ls46;)V
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v3, v2}, Lru/ok/android/externcalls/sdk/signaling/SignalingProviderKt;->get(Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Ls46;)Lwid;
    ...
    :cond_0
    iget-object v4, v0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lv4c;
    ...
    invoke-virtual/range {p1 .. p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getSessionRoomId()Lh5d;

    move-result-object v7

    if-nez v7, :cond_1

    iget-object v7, v0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lh5d;
    ...
    invoke-static {v4, v5}, Lw26;->a(Ljava/lang/String;Lorg/json/JSONObject;)Lm96;

    move-result-object v4

    instance-of v5, v7, Lg5d;
    ...
    invoke-virtual {v4, v6, v5}, Lm96;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {v5, v1, v7, v6}, Lj7c;-><init>(Ljava/lang/Object;Lq46;I)V

    new-instance v6, Lqy0;

    const/4 v7, 0x4

    invoke-direct {v6, v0, v1, v2, v7}, Lqy0;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    const/4 v0, 0x0

    invoke-virtual {v3, v4, v0, v5, v6}, Lwid;->d(Lzid;ZLvid;Lvid;)V
...
.method public stopRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lq46;Ls46;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lv4c;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getSessionRoomId()Lh5d;

    move-result-object v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lh5d;
    ...
    invoke-static {v1, v4}, Lw26;->a(Ljava/lang/String;Lorg/json/JSONObject;)Lm96;

    move-result-object v4

    iget-object v5, v4, Lm96;->a:Lorg/json/JSONObject;

    const-string v6, "command"

    invoke-virtual {v5, v6, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    instance-of v1, v2, Lg5d;
    ...
    invoke-virtual {v4, v2, v1}, Lm96;->b(ILjava/lang/String;)V
    ...
    invoke-direct {v1, p1, p2, v2}, Lj7c;-><init>(Ljava/lang/Object;Lq46;I)V

    new-instance p2, Lqy0;

    const/4 v2, 0x3

    invoke-direct {p2, p0, p1, p3, v2}, Lqy0;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    const/4 p0, 0x0

    invoke-virtual {v0, v4, p0, v1, p2}, Lwid;->d(Lzid;ZLvid;Lvid;)V
