...
.field private final sender:Ls46;
...
.field private final store:Ls46;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ls46;"
        }
...
# direct methods
.method public constructor <init>(Ls46;Ls46;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Ls46;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Ls46;
...
.method public sendDisplayLayouts(Ljava/util/Collection;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Ls46;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lodf;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Ls46;
    ...
    iput-object v3, v4, Llw4;->a:Ljava/lang/Object;

    iput-object v2, v4, Llw4;->b:Ljava/lang/Object;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getVideoTrackParticipantKey()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    move-result-object v2

    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lca9;

    move-result-object v2

    iput-object v2, v4, Llw4;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getLayout()Li7f;

    move-result-object v1

    invoke-direct {v3, v2, v1}, Le51;-><init>(Lpp1;Li7f;)V
