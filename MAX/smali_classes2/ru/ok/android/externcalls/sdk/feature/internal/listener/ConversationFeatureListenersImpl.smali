...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "listener",
        "notifyNewListener",
        "(Le71;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V",
        "addFeatureListener",
        ...
        "(Le71;)Z",
        "getFeatureRoles",
        "(Le71;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;",
        "Lh71;",
        "onFeatureSetChanged",
        "(Lh71;)V",
...
.method private final getFeaturesRolesMap(Li71;)Ljava/util/Map;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {}, Le71;->values()[Le71;
    ...
    iget-object v4, p1, Li71;->a:Ljava/util/Map;
...
.method private final notifyListenersWithNewEnabledFeatures(Ljava/util/Set;Ljava/util/Set;)V
    ...
    invoke-static {p2, p1}, Lj6d;->a0(Ljava/lang/Iterable;Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-interface {v3, v1, v4}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Le71;Z)V

    goto :goto_0

    :cond_1
    invoke-static {p1, p2}, Lj6d;->a0(Ljava/lang/Iterable;Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-interface {v1, p2, v2}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Le71;Z)V
...
.method private final notifyListenersWithNewFeaturesRoles(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-static {v0, v1}, Lj6d;->b0(Ljava/util/Set;Ljava/util/Collection;)Ljava/util/LinkedHashSet;
    ...
    invoke-interface {v3, v1, v5}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Le71;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
...
.method private final notifyNewListener(Le71;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 1

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->isFeatureEnabled(Le71;)Z

    move-result v0

    invoke-interface {p2, p1, v0}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureEnabledChanged(Le71;Z)V

    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->getFeatureRoles(Le71;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;

    move-result-object p0

    invoke-interface {p2, p1, p0}, Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;->onFeatureRolesChanged(Le71;Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;)V
...
# virtual methods
.method public addFeatureListener(Le71;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->notifyNewListener(Le71;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V

    return-void
.end method

.method public getFeatureRoles(Le71;)Lru/ok/android/externcalls/sdk/feature/roles/FeatureRoles;
    .locals 1
...
.method public isFeatureEnabled(Le71;)Z
    .locals 0
...
.method public final onFeatureSetChanged(Lh71;)V
    .locals 1
    ...
    iget-object p1, p1, Lh71;->a:Ljava/util/Set;
...
.method public final onFeaturesPerRoleChanged(Li71;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->getFeaturesRolesMap(Li71;)Ljava/util/Map;
...
.method public removeFeatureListener(Le71;Lru/ok/android/externcalls/sdk/feature/ConversationFeatureManager$FeatureListener;)V
    .locals 0
