...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;->addParticipants(Ljava/util/Collection;Ljava/lang/Boolean;ZLs46;Ls46;)V
.end annotation
...
# direct methods
.method public constructor <init>(Ljava/util/Collection;Ljava/lang/Boolean;ZLs46;Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Ls46;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onError:Ls46;
    ...
    iput-object p6, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onSuccess:Ls46;
...
.method public static synthetic a(Ls46;Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->invoke$lambda$5(Ls46;Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic b(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Ls46;Ls46;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->invoke$lambda$4(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Ls46;Ls46;Lorg/json/JSONObject;)V

    return-void
.end method

.method private static final invoke$lambda$4(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Ls46;Ls46;Lorg/json/JSONObject;)V
    .locals 8
    ...
    :cond_0
    invoke-static {v5}, Lw26;->L(Lorg/json/JSONObject;)Llg1;

    move-result-object v6

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;->access$getCall$p(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;)Lyy0;

    move-result-object v7

    invoke-virtual {v7, v6, v5}, Lyy0;->y(Llg1;Lorg/json/JSONObject;)I
    ...
    invoke-static {v0, p3}, Lw26;->U(Ljava/lang/String;Lorg/json/JSONObject;)Ljava/util/ArrayList;
    ...
    invoke-static {v4, p3}, Lw26;->U(Ljava/lang/String;Lorg/json/JSONObject;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p3, v5}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Llg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-virtual {p0, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Llg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private static final invoke$lambda$5(Ls46;Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lorg/json/JSONObject;)V
    .locals 0
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->invoke(Lwid;)V
...
.method public final invoke(Lwid;)V
    .locals 6
    ...
    invoke-static {v0, v1, v2}, Lw26;->n(Ljava/util/Collection;Ljava/lang/Boolean;Z)Lm96;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onSuccess:Ls46;

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onError:Ls46;

    new-instance v4, Lru/ok/android/externcalls/sdk/participant/c;

    invoke-direct {v4, v1, v2, v3}, Lru/ok/android/externcalls/sdk/participant/c;-><init>(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Ls46;Ls46;)V
    ...
    .line 4
    invoke-virtual {p1, v0, v1, v4, v2}, Lwid;->d(Lzid;ZLvid;Lvid;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 5
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onError:Ls46;
