...
# direct methods
.method public constructor <init>(Lorg/webrtc/DataChannel;Lryb;)V
    .locals 1
    ...
    iput-object v0, p0, Ls24;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Ls24;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Ls24;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Ls24;->a:Lorg/webrtc/DataChannel;

    iput-object p2, p0, Ls24;->b:Lryb;

    new-instance p2, Lr2b;

    const/16 v0, 0xd

    invoke-direct {p2, p0, v0, p1}, Lr2b;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
# virtual methods
.method public final a(Lqjc;)V
    .locals 0

    if-eqz p1, :cond_0

    iget-object p0, p0, Ls24;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()Z
    ...
    iget-object p0, p0, Ls24;->a:Lorg/webrtc/DataChannel;
...
.method public final varargs d([Ljava/nio/ByteBuffer;)V
    ...
    iget-object v3, p0, Ls24;->b:Lryb;

    const-string v4, "DataChannelRtcTransport"

    invoke-interface {v3, v4, v1, v2}, Lryb;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
