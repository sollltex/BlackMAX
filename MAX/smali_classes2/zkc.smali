...
.method public constructor <init>(I)V
    ...
    iput-object p1, p0, Lzkc;->a:[B

    const/16 p1, 0x50

    new-array p1, p1, [J

    iput-object p1, p0, Lzkc;->m:[J

    const/4 p1, 0x0

    iput p1, p0, Lzkc;->b:I

    invoke-virtual {p0}, Lzkc;->m()V
...
.method public final a(I[B)I
    ...
    invoke-virtual {p0}, Lzkc;->j()V

    iget-wide v0, p0, Lzkc;->e:J

    invoke-static {p1, p2, v0, v1}, Lj36;->R(I[BJ)V

    iget-wide v0, p0, Lzkc;->f:J

    add-int/lit8 v2, p1, 0x8

    invoke-static {v2, p2, v0, v1}, Lj36;->R(I[BJ)V

    iget-wide v0, p0, Lzkc;->g:J

    add-int/lit8 v2, p1, 0x10

    invoke-static {v2, p2, v0, v1}, Lj36;->R(I[BJ)V

    iget-wide v0, p0, Lzkc;->h:J

    add-int/lit8 v2, p1, 0x18

    invoke-static {v2, p2, v0, v1}, Lj36;->R(I[BJ)V

    iget-wide v0, p0, Lzkc;->i:J

    add-int/lit8 v2, p1, 0x20

    invoke-static {v2, p2, v0, v1}, Lj36;->R(I[BJ)V

    iget-wide v0, p0, Lzkc;->j:J

    add-int/lit8 v2, p1, 0x28

    invoke-static {v2, p2, v0, v1}, Lj36;->R(I[BJ)V

    iget-wide v0, p0, Lzkc;->k:J

    add-int/lit8 v2, p1, 0x30

    invoke-static {v2, p2, v0, v1}, Lj36;->R(I[BJ)V

    iget-wide v0, p0, Lzkc;->l:J
...
.method public final c(B)V
    ...
    invoke-virtual {p0, p1, v2}, Lzkc;->l(I[B)V

    iput p1, p0, Lzkc;->b:I

    :cond_0
    iget-wide v0, p0, Lzkc;->c:J

    const-wide/16 v2, 0x1

    add-long/2addr v0, v2

    iput-wide v0, p0, Lzkc;->c:J
...
.method public final d(II[B)V
    ...
    invoke-virtual {p0, v0}, Lzkc;->c(B)V
    ...
    :cond_0
    :goto_1
    iget-object v0, p0, Lzkc;->a:[B

    array-length v1, v0

    if-le p2, v1, :cond_1

    invoke-virtual {p0, p1, p3}, Lzkc;->l(I[B)V
...
.method public final j()V
    ...
    iget-wide v2, p0, Lzkc;->d:J

    const/16 v4, -0x80

    :goto_0
    invoke-virtual {p0, v4}, Lzkc;->c(B)V
    ...
    invoke-virtual {p0}, Lzkc;->k()V

    :cond_2
    iget-object v4, p0, Lzkc;->m:[J
...
.method public final k()V
    ...
    iget-wide v7, v0, Lzkc;->d:J

    ushr-long v9, v1, v6

    add-long/2addr v7, v9

    iput-wide v7, v0, Lzkc;->d:J

    and-long/2addr v1, v3

    iput-wide v1, v0, Lzkc;->c:J

    :cond_0
    const/16 v2, 0x10

    :goto_0
    iget-object v3, v0, Lzkc;->m:[J
    ...
    :cond_1
    iget-wide v6, v0, Lzkc;->e:J

    iget-wide v8, v0, Lzkc;->f:J

    iget-wide v10, v0, Lzkc;->g:J

    iget-wide v12, v0, Lzkc;->h:J

    iget-wide v14, v0, Lzkc;->i:J

    iget-wide v1, v0, Lzkc;->j:J

    iget-wide v4, v0, Lzkc;->k:J

    move-wide/from16 v17, v1

    iget-wide v1, v0, Lzkc;->l:J
    ...
    invoke-static/range {v29 .. v30}, Lzkc;->i(J)J
    ...
    invoke-static/range {v21 .. v26}, Lzkc;->f(JJJ)J

    move-result-wide v10

    add-long/2addr v8, v10

    sget-object v32, Lzkc;->p:[J
    ...
    invoke-static {v12, v13}, Lzkc;->h(J)J
    ...
    invoke-static/range {v6 .. v11}, Lzkc;->g(JJJ)J
    ...
    invoke-static/range {v34 .. v35}, Lzkc;->i(J)J
    ...
    invoke-static/range {v19 .. v20}, Lzkc;->h(J)J
    ...
    invoke-static/range {v27 .. v28}, Lzkc;->i(J)J
    ...
    invoke-static {v4, v5}, Lzkc;->h(J)J
    ...
    invoke-static {v14, v15}, Lzkc;->i(J)J
    ...
    invoke-static/range {v17 .. v18}, Lzkc;->h(J)J
    ...
    invoke-static {v12, v13}, Lzkc;->i(J)J
    ...
    invoke-static/range {v6 .. v11}, Lzkc;->f(JJJ)J
    ...
    invoke-static/range {v24 .. v25}, Lzkc;->h(J)J
    ...
    invoke-static/range {v19 .. v20}, Lzkc;->i(J)J
    ...
    invoke-static/range {v21 .. v22}, Lzkc;->h(J)J
    ...
    invoke-static {v4, v5}, Lzkc;->i(J)J
    ...
    invoke-static/range {v27 .. v28}, Lzkc;->h(J)J
    ...
    invoke-static/range {v17 .. v18}, Lzkc;->i(J)J
    ...
    invoke-static {v14, v15}, Lzkc;->h(J)J
    ...
    :cond_2
    iget-wide v8, v0, Lzkc;->e:J

    add-long/2addr v8, v12

    iput-wide v8, v0, Lzkc;->e:J

    iget-wide v8, v0, Lzkc;->f:J

    add-long/2addr v8, v14

    iput-wide v8, v0, Lzkc;->f:J

    iget-wide v8, v0, Lzkc;->g:J

    add-long v8, v8, v27

    iput-wide v8, v0, Lzkc;->g:J

    iget-wide v8, v0, Lzkc;->h:J

    add-long/2addr v8, v6

    iput-wide v8, v0, Lzkc;->h:J

    iget-wide v6, v0, Lzkc;->i:J

    add-long v6, v6, v29

    iput-wide v6, v0, Lzkc;->i:J

    iget-wide v6, v0, Lzkc;->j:J

    add-long v6, v6, v17

    iput-wide v6, v0, Lzkc;->j:J

    iget-wide v6, v0, Lzkc;->k:J

    add-long/2addr v6, v4

    iput-wide v6, v0, Lzkc;->k:J

    iget-wide v4, v0, Lzkc;->l:J

    add-long v4, v4, v19

    iput-wide v4, v0, Lzkc;->l:J
...
.method public final l(I[B)V
    ...
    invoke-static {p1, p2}, Lj36;->j(I[B)I
...
.method public final m()V
    ...
    invoke-virtual {p0}, Lzkc;->n()V

    const-wide v0, 0x6a09e667f3bcc908L    # 6.344059688352415E202

    iput-wide v0, p0, Lzkc;->e:J

    const-wide v0, -0x4498517a7b3558c5L    # -1.5671250923562117E-22

    iput-wide v0, p0, Lzkc;->f:J

    const-wide v0, 0x3c6ef372fe94f82bL    # 1.342284505169847E-17

    iput-wide v0, p0, Lzkc;->g:J

    const-wide v0, -0x5ab00ac5a0e2c90fL

    iput-wide v0, p0, Lzkc;->h:J
    ...
    iput-wide v0, p0, Lzkc;->j:J

    const-wide v0, 0x1f83d9abfb41bd6bL    # 7.229011495228878E-157

    iput-wide v0, p0, Lzkc;->k:J

    const-wide v0, 0x5be0cd19137e2179L    # 3.816167663240759E134

    iput-wide v0, p0, Lzkc;->l:J
