...
.field private final create:Ls46;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ls46;"
        }
...
.method public constructor <init>(ILs46;)V
    ...
    iput-object p2, p0, Lkotlinx/coroutines/internal/OnDemandAllocatingPool;->create:Ls46;
...
.method private final synthetic loop$atomicfu(Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;Ls46;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final allocate()Z
    ...
    iget-object p0, p0, Lkotlinx/coroutines/internal/OnDemandAllocatingPool;->create:Ls46;
...
.method public final close()Ljava/util/List;
    ...
    :goto_0
    invoke-static {v4, v1}, Ldw7;->Q(II)Lb27;
