...
.method public constructor <init>(Lxd7;Lxd7;Lxd7;)V
    ...
    iput-object p3, p0, Lzma;->a:Lxd7;

    iput-object p1, p0, Lzma;->b:Lxd7;

    iput-object p2, p0, Lzma;->c:Lxd7;
    ...
    iput-object p1, p0, Lzma;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lzma;->e:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Lzma;->e:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2}, Lsp1;->c()V

    const/4 v3, 0x0

    iput-object v3, v2, Lsp1;->f:Lr2f;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lsp1;->g:Z

    goto :goto_0

    :cond_0
    iget-object p0, p0, Lzma;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final createVideoViewInstance(Landroid/content/Context;)Lru/ok/android/externcalls/sdk/ui/RendererView;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILg94;)V
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Lzma;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Lb31;->b()Z

    move-result v2

    check-cast v1, Lsp1;

    iget-object v3, v1, Lsp1;->h:Lldf;

    if-eqz v3, :cond_0

    const/4 v4, 0x1

    iget-boolean v3, v3, Lldf;->c:Z

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lsp1;->c:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lzma;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-interface {v0}, Lrg1;->s()Lldf;

    move-result-object v0

    iget-object v0, v0, Lldf;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lzma;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lzma;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    invoke-virtual {p2}, Lwma;->c()Lyla;

    move-result-object p2

    iget-object p2, p2, Lyla;->a:Lrg1;

    invoke-interface {p2}, Lrg1;->s()Lldf;

    move-result-object p2

    iget-object p2, p2, Lldf;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lzma;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    sget-object v2, Lodf;->a:Lodf;

    if-ne v1, v2, :cond_1

    iget-object p0, p0, Lzma;->a:Lxd7;
